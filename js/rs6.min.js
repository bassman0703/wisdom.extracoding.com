...
!function (e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
        revolution: function (a) {
            return this.each(function () {
                ...
                this.id !== t ? (i[s] = {anyid: []}, this.id = i.revCheckIDS(s, this, !0)) : this.id = "rs_module_" + Math.round(1e7 * Math.random());
                var s = this.id, n = e.extend(!0, {}, a);
        ...
        pageHandler: function (a) {
            ...
            }), tpGS.BounceLite = tpGS.CustomBounce.create("BounceLite", {strength: .3}), tpGS.BounceSolid = tpGS.CustomBounce.create("BounceSolid", {strength: .5}), tpGS.BounceStrong = tpGS.CustomBounce.create("BounceStrong", {strength: .7}), tpGS.BounceExtrem = tpGS.CustomBounce.create("BounceExtrem", {strength: .9})), i.checkParrentOverflows(a);
            ...
            if (a !== t && i[a] !== t && "clicked" !== i[a].modal.closeProtection) {
                ...
                switch (r.mode) {
                    case"show":
                        ...
                        var o = {a: 0};
                        tpGS.gsap.fromTo(o, .01, {a: 0}, {
                            a: 10, ease: "power3.inOut", onStart: function () {
                            ...
                            if (p[d].src = f.src, "img" == f.type) {
                                if (g.slidebgimage) {
                                    ...
                                    if (v.length > 0 && (i.sA(v[0], "owidth", f.width), i.sA(v[0], "oheight", f.height)), "carousel" === i[o].sliderType) {
                                        var y = e(v), _ = i.getSlideIndex(o, i.gA(l[c], "key"));
            ...
            var r, o, s = parseInt(i[e].top_outer || 0) + parseInt(i[e].bottom_outer || 0), n = 0, l = 0, d = 0,
                c = i[e].pr_processing_key || i[e].pr_active_key || 0, p = i[e].pr_active_key || 0, u = {}, g = {};
            if (u.marginTop = "carousel" == i[e].sliderType ? parseInt(i[e].carousel.padding_top || 0, 0) : 0, u.marginBottom = "carousel" == i[e].sliderType ? parseInt(i[e].carousel.padding_bottom || 0, 0) : 0, i[e].blockSpacing !== t && tpGS.gsap.set(i[e].blockSpacing.block, {
                ...
                if (i[e].rowzones[c] !== t) for (r = 0; r < i[e].rowzones[c].length; r++) i[e].rowzonesHeights[c][r] = i[e].rowzones[c][r][0].offsetHeight, n += i[e].rowzonesHeights[c][r];
                if (p !== c) for (r = 0; r < i[e].rowzones[p].length; r++) i[e].rowzonesHeights[p][r] = i[e].rowzones[p][r][0].offsetHeight, l += i[e].rowzonesHeights[p][r];
                n = l / 2 > n ? l : n
            }
            if (i[e].srowzones && i[e].srowzones.length > 0) for (r = 0; r < i[e].srowzones.length; r++) d += i[e].srowzones[r][0].offsetHeight;
            ...
            if (o = u.marginTop + u.marginBottom + s + i[e].height + i[e].paddings.top + i[e].paddings.bottom, u.marginTop = 0, u.marginBottom = 0, !1 !== a && (g.height = o), i[e].sbtimeline.set && i[e].sbtimeline.fixed) {
                ...
                h !== i[e].caches.setsize__h && (i[e].caches.setsize__h = h, tpGS.gsap.set(i[e].forcer, {height: h}))
            } else !1 !== a && o !== i[e].caches.setsize_h && i[e].forcer !== t && (i[e].caches.setsize_h = o, tpGS.gsap.set(i[e].forcer, {height: o}));
            ...
            i[r].pr_next_slide.find("rs-bgvideo").each(function (o) {
                ...
                var s = e(this);
                i.resetVideo(s, r, !1, !0), i[r].videoOutAnim !== t && i[r].videoOutAnim[this.id] !== t && i[r].videoOutAnim[this.id].pause(), tpGS.gsap.fromTo(s, .01, {autoAlpha: 0}, {
                    autoAlpha: 1,
                    ease: "power3.out",
                    onComplete: function () {
    ...
    var a = i.is_mobile(), r = (i.is_android(), function (e) {
        ...
        i[e].editorheight !== t && (a = Math.max(a, i[e].editorheight[i[e].level] * i[e].bw)), tpGS.gsap.set(i[e].c, {height: a})
    }), o = function (t, i) {
        var a = [];
        ...
        if (i[r] !== t) {
            ...
            for (var g in i[r].slides) if (i[r].slides.hasOwnProperty(g) && "length" !== g) {
                var m = i[r].slides[g], f = m.getElementsByTagName("img")[0];
                ...
                i.gA(m, "title") === t && i.sA(m, "title", ""), i.gA(m, "description") === t && i.sA(m, "description", ""), v.params[0] = {
                    from: RegExp("\\{\\{title\\}\\}", "g"),
                    to: i.gA(m, "title")
                }, v.params[1] = {from: RegExp("\\{\\{description\\}\\}", "g"), to: i.gA(m, "description")};
                for (var _ = 1; _ <= 10; _++) i.gA(m, "p" + _) !== t ? v.params[_ + 1] = {
                    from: RegExp("\\{\\{param" + _ + "\\}\\}", "g"),
                    to: i.gA(m, "p" + _)
                } : v.params[_ + 1] = {from: RegExp("\\{\\{param" + _ + "\\}\\}", "g"), to: ""};
                if (i[r].thumbs[d] = e.extend({}, !0, v), c > 0 && tpGS.gsap.set(m, {borderRadius: c + "px"}), i.gA(m, "link") != t || i.gA(m, "linktoslide") !== t) {
                    var b = i.gA(m, "link") !== t ? i.gA(m, "link") : "slide",
                        w = "slide" != b ? "no" : i.gA(m, "linktoslide"), x = i.gA(m, "seoz");
                    if (w != t && "no" != w && "next" != w && "prev" != w) for (var k in i[r].slides) i[r].slides.hasOwnProperty(k) && parseInt(i.gA(i[r].slides[k], "origindex"), 0) + 1 == i.gA(m, "linktoslide") && (w = i.gA(i[r].slides[k], "key"));
            ...
            if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({overflow: "visible"}), 0 !== i[r].maxHeight && tpGS.gsap.set([i[r].cpar, i[r].c, i[r].topc], {maxHeight: i[r].maxHeight + "px"}), i[r].fixedOnTop && tpGS.gsap.set(i[r].blockSpacing !== t && i[r].blockSpacing.block !== t ? i[r].blockSpacing.block : i[r].topc, {
                ...
                i[r].c[0].classList.add("revslider-initialised"), i[r].c[0].id = i[r].c[0].id === t ? "revslider-" + Math.round(1e3 * Math.random() + 5) : i[r].c[0].id, i.revCheckIDS(r, i[r].c[0]), i[r].origcd = parseInt(i[r].duration, 0), i[r].scrolleffect._L = [], i[r].sbas = i[r].sbas === t ? {} : i[r].sbas, i[r].layers = i[r].layers || {}, i[r].sortedLayers = i[r].sortedLayers || {}, i[r].c.find("rs-layer, rs-row, rs-column, rs-group,  rs-bgvideo, .rs-layer").each(function () {
                    ...
                    if ("true" != n.animationonscroll && 1 != n.animationonscroll || (n.startclasses += " rs-sba", s[0].className += " rs-sba"), n.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(s, r), "RS-BGVIDEO" !== s[0].tagName) {
                        ...
                        var c = n.startclasses.indexOf("slidelink") >= 0 ? "width:100% !important;height:100% !important;" : "",
                            ...
                            h = "", f = "", v = (n.noPevents, ";pointer-events:none");
                ...
                if (T.length < 9 && T.split("slide").length > 1 && -1 == T.indexOf("slider")) {
                    ...
                    e.isNumeric(parseInt(O, 0)) && ((O = parseInt(O, 0)) < 1 && (O = 1), O > i[r].slideamount && (O = i[r].slideamount), i[r].startWithSlide = O - 1)
                }
                ...
                var A = i[r].viewPort;
                for (var _ in i[r].slides) if (i[r].slides.hasOwnProperty(_)) {
        ...
        i[a].startWithSlide = i[a].startWithSlide === t ? t : "carousel" === i[a].sliderType ? parseInt(i[a].startWithSlide) : parseInt(i[a].startWithSlide) + 1, i[a].cpar.css({overflow: "visible"}), i[a].scrolleffect.bgs = [];
        for (var o = 0; o < i[a].slides.length; o++) {
            ...
            var d = n.closest("rs-sbg-wrap"), c = s.data("mediafilter"), p = _(n.data(), a),
            ...
            p.src = n[0].src, p.lazyload = u(n[0], t, a), p.slidebgimage = !0, c = "none" === c || c === t ? "" : c, l.length > 0 && (l.addClass("defaultvid").css({zIndex: 30}), c !== t && "" !== c && "none" !== c && l.addClass(c), l.appendTo(d), p.parallax != t && (l.data("parallax", p.parallax), l.data("showcoveronpause", "on"), l.data("mediafilter", c))), "none" != i[a].dottedOverlay && i[a].dottedOverlay != t && d.append('<rs-dotted class="' + i[a].dottedOverlay + '"></rs-dotted>'), m += (g ? "" : "background-repeat:" + p.bgrepeat + ";background-image:url(" + p.src + ");background-size:" + p.bgfit + ";background-position:" + p.bgposition + ";") + "width:100%;height:100%;", m += "standard" === i[a].sliderType || "undefined" === i[a].sliderType ? "opacity:0;" : "", n.data("mediafilter", c), c = n.data("panzoom") !== t ? "" : c;
        ...
        if (i[r] !== t) {
            ...
            }, i[r].c.trigger("revolution.slide.onbeforeswap", i[r].onBeforeSwap), i[r].transition = 1, i[r].stopByVideo = !1, i[r].pr_next_slide[0] !== t && i.gA(i[r].pr_next_slide[0], "duration") != t && "" != i.gA(i[r].pr_next_slide[0], "duration") ? i[r].duration = parseInt(i.gA(i[r].pr_next_slide[0], "duration"), 0) : i[r].duration = i[r].origcd, i[r].pr_next_slide[0] === t || "true" != i.gA(i[r].pr_next_slide[0], "ssop") && !0 !== i.gA(i[r].pr_next_slide[0], "ssop") ? i[r].ssop = !1 : i[r].ssop = !0, i[r].sbtimeline.set && i[r].sbtimeline.fixed && i.updateFixedScrollTimes(r), i[r].c.trigger("nulltimer"), i[r].sdir = i[r].pr_processing_key < i[r].pr_active_key ? 1 : 0, "arrow" == i[r].sc_indicator && (0 == i[r].pr_active_key && i[r].pr_processing_key == i[r].slideamount - 1 && (i[r].sdir = 1), i[r].pr_active_key == i[r].slideamount - 1 && 0 == i[r].pr_processing_key && (i[r].sdir = 0)), i[r].lsdir = i[r].sdir, i[r].pr_active_key != i[r].pr_processing_key && 1 != i[r].firststart && "carousel" !== i[r].sliderType && i.removeTheLayers && i.removeTheLayers(i[r].pr_active_slide, r), 1 !== i.gA(i[r].pr_next_slide[0], "rspausetimeronce") && 1 !== i.gA(i[r].pr_next_slide[0], "rspausetimeralways") ? i[r].c.trigger("restarttimer") : (i[r].stopByVideo = !0, i.unToggleState(i[r].slidertoggledby)), i.sA(i[r].pr_next_slide[0], "rspausetimeronce", 0), i[r].pr_next_slide[0] !== t && i.sA(i[r].c[0], "slideactive", i.gA(i[r].pr_next_slide[0], "key")), "carousel" == i[r].sliderType) i[r].mtl = tpGS.gsap.timeline(), i.prepareCarousel(r), z(r), i.playBGVideos(r), i[r].transition = 0; else {
                i[r].mtl = tpGS.gsap.timeline({
                    paused: !0, onComplete: function () {
                        z(r)
                    }
                }), i.playBGVideos(r), i[r].mtl.add(tpGS.gsap.set(i[r].pr_next_bg.find("rs-sbg"), {opacity: 0})), i[r].pr_next_key !== t ? i.animateTheLayers({
                    slide: i[r].pr_next_key,
                    id: r,
                    mode: "preset",
    ...
    var z = function (r) {
        if (i[r] !== t) {
            ...
            if (i[r].firstSlideAvailable === t && (i[r].firstSlideAvailable = !0, window.requestAnimationFrame(function () {
                ...
                if (i[r].c.trigger("revolution.slide.onchange", l), i[r].c.trigger("revolution.slide.onafterswap", l), i[r].pr_lastshown_key = i[r].pr_active_key, i[r].startWithSlide !== t && "done" !== i[r].startWithSlide && "carousel" === i[r].sliderType) {
                    for (var d = i[r].startWithSlide, c = 0; c <= i[r].slides.length - 1; c++) i[r].slides[c] !== t && i[r].slides[c][0] !== t && i.gA(i[r].slides[c][0], "originalindex") === i[r].startWithSlide && (d = c);
                    0 !== d && i.callingNewSlide(r, d), i[r].startWithSlide = "done"
                }
                ...
                var p = i[r].pr_processing_key || i[r].pr_active_key || 0;
                i[r].rowzones != t && (p = p > i[r].rowzones.length ? i[r].rowzones.length : p), i[r].rowzones != t && i[r].rowzones.length > 0 && i[r].rowzones[p] != t && p >= 0 && p <= i[r].rowzones.length && i[r].rowzones[p].length > 0 && i.setSize(r), delete i[r].sc_indicator, delete i[r].sc_indicator_dir, i[r].firstLetItFree === t && (i.generalObserver(a), i[r].firstLetItFree = !0)
            }
        }
    }, P = function (r) {
        i[r].loop = 0, i[r].stopAtSlide != t && i[r].stopAtSlide > -1 ? i[r].lastslidetoshow = i[r].stopAtSlide : i[r].lastslidetoshow = 999, i[r].stopLoop = !1, 0 == i[r].looptogo && (i[r].stopLoop = !0), i[r].c.on("stoptimer", function () {
            i[r].progressC[0].tween.pause(), i[r].disableProgressBar && i[r].progressC.css({visibility: "hidden"}), i[r].sliderstatus = "paused", i[r].slideInSwapTimer || i.unToggleState(i[r].slidertoggledby), i[r].slideInSwapTimer = !1
        }), i[r].c.on("starttimer", function () {
            i[r].forcepaused || (1 != i[r].conthover && 1 != i[r].stopByVideo && i[r].width > i[r].hideSliderAtLimit && 1 != i[r].tonpause && 1 != i[r].overnav && 1 != i[r].ssop && (1 === i[r].noloopanymore || i[r].viewPort.enable && !i[r].inviewport || (i[r].progressC.css({visibility: "visible"}), i[r].progressC[0].tween.resume(), i[r].sliderstatus = "playing")), i[r].disableProgressBar && i[r].progressC.css({visibility: "hidden"}), i.toggleState(i[r].slidertoggledby))
        }), i[r].c.on("restarttimer", function () {
            if (!i[r].forcepaused) {
                if (i[r].mouseoncontainer && "on" == i[r].navigation.onHoverStop && !a) return !1;
                1 === i[r].noloopanymore || i[r].viewPort.enable && !i[r].inviewport || 1 == i[r].ssop ? i.unToggleState(i[r].slidertoggledby) : (i[r].progressC.css({visibility: "visible"}), i[r].progressC[0].tween.kill(), i[r].progressC[0].tween = tpGS.gsap.fromTo(i[r].progressC, i[r].duration / 1e3, {scaleX: 0}, {
                    force3D: "auto",
                    scaleX: 1,
                    ease: "none",
                    onComplete: o,
                    delay: 1
                }), i[r].sliderstatus = "playing", i.toggleState(i[r].slidertoggledby)), i[r].disableProgressBar && i[r].progressC.css({visibility: "hidden"}), i[r].mouseoncontainer && 1 == i[r].navigation.onHoverStop && !a && (i[r].c.trigger("stoptimer"), i[r].c.trigger("revolution.slide.onpause"))
            }
        }), i[r].c.on("nulltimer", function () {
            i[r].progressC[0].tween.kill(), i[r].progressC[0].tween = tpGS.gsap.fromTo(i[r].progressC, i[r].duration / 1e3, {scaleX: 0}, {
                force3D: "auto",
                scaleX: 1,
                ease: "none",
                onComplete: o,
                delay: 1
            }), i[r].progressC[0].tween.pause(0), i[r].disableProgressBar && i[r].progressC.css({visibility: "hidden"}), i[r].sliderstatus = "paused"
        });
        var o = function () {
        ...
        prepareCarousel: function (e, i, a) {
            if (void 0 !== e) {
                ...
                o.slidepositions = void 0 === o.slidepositions ? [] : o.slidepositions, o.slideFakePositions = void 0 === o.slideFakePositions ? [] : o.slideFakePositions, i = o.lastdirection = r(i, o.lastdirection), t.setCarouselDefaults(e), void 0 === o.slidepositions[0] && (o.slideAnims = [], t.organiseCarousel(e, "right", !0, !1, !1), o.focused = 0, o.keepFocusedFirst = !0), o.slide_offset = void 0 !== o.slide_offset && jQuery.isNumeric(o.slide_offset) ? o.slide_offset : 0, o.swipeTo = o.slide_offset + s(e), void 0 !== o.swipeTo && jQuery.isNumeric(o.swipeTo) ? void 0 !== a ? t.swipeAnimate({
                    ...
                    fix: !0,
                    speed: a
                }) : t.swipeAnimate({id: e, to: o.swipeTo, direction: i, fix: !0}) : t.swipeAnimate({
                    id: e,
                    to: 0,
                    direction: i,
                    speed: 0
            ...
            var _ = 999, b = 0, w = (t[e].width, !1), x = "right" === s.horizontal_align ? 0 : s.wrapwidth;
    ...
    jQuery.extend(!0, o, {
        checkLayerDimensions: function (e) {
            ...
            })); else for (a in o[e]._L) o[e]._L.hasOwnProperty(a) && (o[e]._L[a].pVisRequest !== o[e]._L[a].pVisStatus && (o[e]._L[a].pVisStatus = o[e]._L[a].pVisRequest, 0 === o[e]._L[a].pVisStatus ? o[e]._L[a].p[0].classList.add("rs-forcehidden") : o[e]._L[a].p[0].classList.remove("rs-forcehidden")), o[e]._L[a].pPointerStatus !== o[e]._L[a].pPeventsRequest && (o[e]._L[a].pPointerStatus = o[e]._L[a].pPeventsRequest, tpGS.gsap.set(o[e]._L[a].p[0], {
                pointerEvents: o[e]._L[a].pPointerStatus,
                visibility: o[e]._L[a].pVisStatus
            })));
            if ("enterstage" === t) {
                var r = o[e].pr_processing_key || o[e].pr_active_key || 0;
                if (o[e].middleZones && o[e].middleZones.length > 0 && void 0 !== o[e].middleZones[r]) for (a = 0; a < o[e].middleZones[r].length; a++) tpGS.gsap.set(o[e].middleZones[r][a], {y: Math.round(o[e].height / 2 - o[e].middleZones[r][a].offsetHeight / 2) + "px"});
                if (o[e].smiddleZones && o[e].smiddleZones.length > 0) for (a = 0; a < o[e].smiddleZones.length; a++) tpGS.gsap.set(o[e].smiddleZones[a], {y: Math.round(o[e].height / 2 - o[e].smiddleZones[a].offsetHeight / 2) + "px"});
            ...
            for (var n in o[r].layers[e.skey]) if (o[r].layers[e.skey].hasOwnProperty(n)) {
                ...
                if (void 0 === c) {
                    ...
                    if ("svg" === p.type && (p.svg = d.find("svg"), p.svgPath = p.svg.find("path"), p.svgI = f(p.svgi, r), p.svgH = f(p.svgh, r)), void 0 !== p.btrans) {
                        ...
                        for (t in p.btrans = {
                            ...
                            rZ: 0,
                            o: 1
                        }, m = m.split(";")) if (m.hasOwnProperty(t)) switch ((i = m[t].split(":"))[0]) {
                            case"rX":
                                p.btrans.rX = i[1];
                                break;
                            case"rY":
                    ...
                    if (void 0 !== p.spike && (p.spike = P(p.spike)), void 0 !== p.corners) for (t in a = p.corners.split(";"), p.corners = {}, a) a.hasOwnProperty(t) && a[t].length > 0 && (p.corners[a[t]] = jQuery("<" + a[t] + "></" + a[t] + ">"), p.c.append(p.corners[a[t]]));
                ...
                var h = "grid" === p.basealign ? o[r].width : "carousel" !== o[r].sliderType || p._isstatic ? o[r].width : o[r].carousel.slide_width,
                    ...
                    _ = p.x[o[r].level], b = p.y[o[r].level];
                if (g = "slide" === p.basealign ? 0 : Math.max(0, "fullscreen" == o[r].sliderLayout ? y / 2 - o.iHE(r) * (o[r].keepBPHeight ? 1 : o[r].bh) / 2 : o[r].autoHeight || null != o[r].minHeight && o[r].minHeight > 0 ? o[r].conh / 2 - o.iHE(r) * o[r].bh / 2 : g), u = "slide" === p.basealign ? 0 : Math.max(0, u), "slide" !== p.basealign && "carousel" === o[r].sliderType && p._isstatic && void 0 !== o[r].carousel && void 0 !== o[r].carousel.horizontal_align && (u = Math.max(0, "center" === o[r].carousel.horizontal_align ? 0 + (o[r].width - o.iWA(r, "static") * o[r].bw) / 2 : "right" === o[r].carousel.horizontal_align ? o[r].width - o[r].gridwidth[o[r].level] * o[r].bw : u)), "updateposition" !== e.mode) {
                    if (0 == p.vbility[o[r].levelForced] || "f" == p.vbility[o[r].levelForced] || h < o[r].hideLayerAtLimit && "on" == p.layeronlimit || h < o[r].hideAllLayerAtLimit ? (!0 !== p.layerIsHidden && p.p[0].classList.add("rs-layer-hidden"), p.layerIsHidden = !0) : (p.layerIsHidden && p.p[0].classList.remove("rs-layer-hidden"), p.layerIsHidden = !1), p.poster = null == p.poster && void 0 !== p.thumbimage ? p.thumbimage : p.poster, "image" === p.layertype) if (p.imgOBJ = {}, "cover-proportional" === p.img.data("c")) {
                        ...
                        var w = o.gA(p.img[0], "owidth") / o.gA(p.img[0], "oheight"), x = h / y;
            ...
            void 0 !== i && o[t].layers[i] && o.initLayer({
                ...
                mode: e.mode,
                animcompleted: r
            }), o.updateLayersOnFullStage(t), "preset" !== e.mode || void 0 !== o[t].slidePresets && void 0 !== o[t].slidePresets[e.slide] || (o[t].slidePresets = void 0 === o[t].slidePresets ? {} : o[t].slidePresets, o[t].slidePresets[e.slide] = !0, o[t].c.trigger("revolution.slideprepared", {slide: e.slide})), o[t].lastAnimateLayersCall = {
                id: t,
                skey: i,
                slide: e.slide,
                key: i,
            ...
            var i, a = e.layer, r = e.id, s = o[r].level, m = o[r]._L[a[0].id],
                h = void 0 !== m.timeline ? m.timeline.time() : void 0, f = !1, v = !1, b = "none";
            if (("containerResized_2" !== e.caller && "swapSlideProgress_2" !== e.caller || !0 === m.animationRendered) && (m.animationRendered = !0, "preset" !== e.mode || !0 === m.frames.frame_1.timeline.waitoncall || void 0 !== m.scrollBasedOffset)) {
                if ("trigger" == e.mode && (m.triggeredFrame = e.frame), m._isstatic) {
                    var x = "carousel" === o[r].sliderType && void 0 !== o[r].carousel.oldfocused ? o[r].carousel.oldfocused : void 0 === o[r].pr_lastshown_key ? 1 : parseInt(o[r].pr_lastshown_key, 0) + 1,
                        ...
                        S = x >= m.startslide && x <= m.endslide, L = k >= m.startslide && k <= m.endslide;
                    if (b = x === m.endslide && "continue" === e.mode || ("continue" === e.mode || x === m.endslide) && "none", !0 === e.allforce || !0 === b) ; else {
                ...
                for (var T in "start" === e.mode && (void 0 !== m.layerLoop && (m.layerLoop.count = 0), e.frame = void 0 === m.triggeredFrame ? 0 : m.triggeredFrame), "continue" !== e.mode && "trigger" !== e.mode && void 0 !== m.timeline && m.timeline.pause(0), "continue" !== e.mode && "trigger" !== e.mode || void 0 === m.timeline || m.timeline.pause(), m.timeline = tpGS.gsap.timeline({paused: !0}), "text" !== m.type && "button" !== m.type || void 0 !== m.splitText && (void 0 !== m.splitTextFix || "start" !== e.mode && "preset" !== e.mode) || (y({
                    layer: a,
                    id: r
                }), "start" === e.mode && (m.splitTextFix = !0)), m.ford) if (m.ford.hasOwnProperty(T)) {
                    var O = m.ford[T], A = !1;
                    if ("frame_0" !== O && "frame_hover" !== O && "loop" !== O) {
                        ...
                        if ("frame_999" !== O || !1 !== b || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                            ...
                            var R = m.frames[O], I = m.fff ? m.frames.frame_0 : void 0, z = tpGS.gsap.timeline(),
                                P = tpGS.gsap.timeline(), C = m.c,
                                G = void 0 !== R.sfx && _(R.sfx.effect, m.m, R.timeline.ease),
                                M = R.timeline.speed / 1e3, B = 0, D = w({
                                    id: r,
                                    frame: R,
                                    layer: a,
                                    ...
                                    splitAmount: C.length,
                                    target: "frame_0"
                                }) : void 0, N = void 0 !== R.mask ? w({
                                    id: r,
                                    frame: {transform: {x: R.mask.x, y: R.mask.y}},
                                    layer: a,
                                    ease: D.ease,
                                    target: "mask"
                                }) : void 0, H = void 0 !== N && m.fff ? w({
                                    id: r,
                            ...
                            if (D.force3D = !0, "block" === G.type && (G.ft[0].background = R.sfx.fxc, G.ft[0].visibility = "visible", G.ft[1].visibility = "visible", z.add(tpGS.gsap.fromTo(G.bmask_in, M / 2, G.ft[0], G.ft[1], 0)), z.add(tpGS.gsap.fromTo(G.bmask_in, M / 2, G.ft[1], G.t, M / 2)), "frame_0" !== O && "frame_1" !== O || (j.opacity = 0)), void 0 !== R.color ? D.color = R.color : void 0 !== m.color && "npc" !== m.color[s] && (D.color = m.color[s]), void 0 !== I && void 0 !== I.color ? j.color = I.color : void 0 !== I && void 0 !== m.color && "npc" !== m.color[s] && (j.color = m.color[s]), void 0 !== R.bgcolor ? R.bgcolor.indexOf("gradient") >= 0 ? D.background = R.bgcolor : D.backgroundColor = R.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? D.background = m.bgcol : D.backgroundColor = m.bgcol), void 0 !== I && (void 0 !== I.bgcolor ? I.bgcolor.indexOf("gradient") >= 0 ? j.background = I.bgcolor : j.backgroundColor = I.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? j.background = m.bgcol : j.backgroundColor = m.bgcol)), void 0 !== m.splitText && !1 !== m.splitText) for (var F in t) if (void 0 !== R[t[F]] && !m.quickRendering) {
                                ...
                                var X = jQuery.extend(!0, {}, E), J = m.fff ? jQuery.extend(!0, {}, V) : void 0,
                                    q = R[t[F]].dir;
                            ...
                            if (M += B, void 0 === i && (i = "isometric" === o[r].perspectiveType ? 0 : "local" === o[r].perspectiveType ? void 0 !== D.transformPerspective ? D.transformPerspective : m.fff && void 0 !== j.transfromPerspective ? j.transfromPerspective : o[r].perspective : o[r].perspective), m.pxundermask || void 0 !== N && (void 0 !== I && "hidden" === I.mask.overflow || "hidden" === R.mask.overflow)) z.add(tpGS.gsap.to(m.m, .001, {overflow: "hidden"}), 0), "column" === m.type && z.add(tpGS.gsap.to(m.cbgmask, .001, {overflow: "hidden"}), 0), m.btrans && (H && (H.rotationX = m.btrans.rX, H.rotationY = m.btrans.rY, H.rotationZ = m.btrans.rZ, H.opacity = m.btrans.o), N.rotationX = m.btrans.rX, N.rotationY = m.btrans.rY, N.rotationZ = m.btrans.rZ, N.opacity = m.btrans.o), m.fff ? z.add(tpGS.gsap.fromTo([m.m, m.cbgmask], M, jQuery.extend(!0, {}, H), jQuery.extend(!0, {}, N)), .001) : z.add(tpGS.gsap.to([m.m, m.cbgmask], M, jQuery.extend(!0, {}, N)), .001); else if (void 0 !== m.btrans) {
                                var Z = {
                                    x: 0,
                                    y: 0,
                                    filter: "none",
                            ...
                            } else z.add(tpGS.gsap.to(m.m, .001, {clearProps: "transform", overflow: "visible"}), 0);
                            ...
                            m.timeline.addLabel(O, U), m.timeline.add(z, U), m.timeline.addLabel(O + "_end", "+=0.01"), z.eventCallback("onStart", c, [{
                                ...
                                frame: O,
                                L: a
                            }]), z.eventCallback("onComplete", u, [{id: r, frame: O, L: a}])
                        }
                    }
                }
                if (void 0 !== m.frames.loop) {
                    var K = m.frames.loop.frame_0, $ = m.frames.loop.frame_999, ee = tpGS.gsap.timeline({}),
                        te = tpGS.gsap.timeline({repeat: -1, yoyo: m.frames.loop.timeline.yoyo_move}),
                        ie = tpGS.gsap.timeline({repeat: -1, yoyo: m.frames.loop.timeline.yoyo_rotate}),
                        ae = tpGS.gsap.timeline({repeat: -1, yoyo: m.frames.loop.timeline.yoyo_scale}),
                        re = tpGS.gsap.timeline({repeat: -1, yoyo: m.frames.loop.timeline.yoyo_filter}),
                        oe = parseInt(m.frames.loop.timeline.speed, 0) / 1e3,
                        se = parseInt(m.frames.loop.timeline.start) / 1e3 || 0, ne = se + .2,
                    ...
                    if ("blur(0px) grayscale(0%) brightness(100%)" === le && "blur(0px) grayscale(0%) brightness(100%)" === de && (le = "none", de = "none"), ee.add(te, 0), ee.add(ie, 0), ee.add(ae, 0), ee.add(re, 0), $.originX = K.originX, $.originY = K.originY, $.originZ = K.originZ, m.frames.loop.timeline.curved) {
                        var ce = parseInt(m.frames.loop.timeline.radiusAngle, 0) || 0,
                            pe = [{x: (K.x - K.xr) * o[r].bw, y: 0, z: (K.z - K.zr) * o[r].bw}, {
                                x: 0,
                                y: (K.y + K.yr) * o[r].bw,
                                z: 0
                            }, {x: ($.x + $.xr) * o[r].bw, y: 0, z: ($.z + $.zr) * o[r].bw}, {
                                x: 0,
                                y: ($.y - $.yr) * o[r].bw,
                                z: 0
                            }], ue = {
                    ...
                    he = 0 === he ? 1e-5 : he, m.hoverlistener || (m.hoverlistener = !0, o.document.on("mouseenter mousemove", ("column" === m.type ? "#" + m.cbg[0].id + "," : "") + "#" + m.c[0].id, function (e) {
                        if ("mousemove" !== e.type || !0 !== m.ignoremousemove) {
                            if (m.animationonscroll || m.readyForHover) {
                                if (m.ignoremousemove = !0, m.elementHovered = !0, m.hovertimeline || (m.hovertimeline = tpGS.gsap.timeline({paused: !0})), 0 == m.hovertimeline.progress() && (void 0 === m.lastHoveredTimeStamp || (new Date).getTime() - m.lastHoveredTimeStamp > 1500) && (m.hovertimeline.to([m.m, m.cbgmask], he, {overflow: m.frames.frame_hover.mask ? "hidden" : "visible"}, 0), "column" === m.type && m.hovertimeline.to(m.cbg, he, jQuery.extend(!0, {}, g(m.frames.frame_hover, m.cbg)), 0), "text" !== m.type && "button" !== m.type || void 0 === m.splitText || !1 === m.splitText || m.hovertimeline.to([m.splitText.lines, m.splitText.words, m.splitText.chars], he, {
                                    ...
                                    m.svgHTemp.fill = t, m.hovertimeline.to(m.svg, he, m.svgHTemp, 0), m.hovertimeline.to(m.svgPath, he, {fill: t}, 0)
                                }
                ...
                if (A || (m.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? void 0 === e.frame ? m.currentframe : e.frame : m.lastRequestedMainFrame), void 0 !== e.totime ? m.tSTART = e.totime : void 0 !== h && void 0 === e.frame ? m.tSTART = h : void 0 !== e.frame ? m.tSTART = e.frame : m.tSTART = 0, 0 === m.tSTART && void 0 === m.startedAnimOnce && void 0 === m.leftstage && void 0 === m.startedAnimOnce && !0 === m.hideonfirststart && "preset" === e.mode && (o[r]._L[a[0].id].pVisRequest = 0, m.hideonfirststart = !1), "frame_999" !== m.tSTART && "frame_999" !== m.triggeredFrame || !m.leftstage && void 0 !== m.startedAnimOnce) {
                    if ("true" != m.animationonscroll && 1 != m.animationonscroll ? m.timeline.play(m.tSTART) : m.timeline.time(m.tSTART), jQuery.inArray(m.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        if (void 0 === m.childrenJS) for (var F in m.childrenJS = {}, o[r]._L) void 0 !== o[r]._L[F]._lig && void 0 !== o[r]._L[F]._lig[0] && o[r]._L[F]._lig[0].id === a[0].id && o[r]._L[F]._lig[0].id !== o[r]._L[F].c[0].id && (m.childrenJS[o[r]._L[F].c[0].id] = o[r]._L[F].c);
                        ...
                        if (!0 === e.updateChildren) for (var F in m.childrenJS) m.childrenJS.hasOwnProperty(F) && o.renderLayerAnimation({
                            ...
                            updateChildren: !0,
                            totime: fe
                        }); else for (var F in m.childrenJS) m.childrenJS.hasOwnProperty(F) && o[r]._L[F].pausedTrueParrent && (o.renderLayerAnimation({
                            layer: m.childrenJS[F],
                            fastforward: !1,
                            id: r,
                            mode: "continue",
    ...
    var n = function (e) {
        ...
        var t, i = o[e.id]._L[e.layer[0].id],
            ...
            r = {originX: "50%", originY: "50%", originZ: "0"}, s = o[e.id].conw, n = o[e.id].conh;
        for (var l in a) if (a.hasOwnProperty(l)) {
            ...
            } else if (a[l].indexOf("%") >= 0 && jQuery.isNumeric(t = parseInt(a[l], 0))) a[l] = "x" === l ? b((i.eow || 0) * t / 100, e.frame.reverse, e.target, l, e.id) : "y" === l ? b((i.eoh || 0) * t / 100, e.frame.reverse, e.target, l, e.id) : a[l]; else switch (a[l] = a[l].replace("[", "").replace("]", ""), a[l] = b(a[l], e.frame.reverse, e.target, l, e.id, e.id), a[l]) {
                case"t":
                case"top":
        ...
        if (a.transformOrigin = r.originX + " " + r.originY + " " + r.originZ, !o[e.id].BUG_ie_clipPath && void 0 !== a.clip && void 0 !== i.clipPath && i.clipPath.use) {
            var c = "rectangle" == i.clipPath.type, p = parseInt(a.clip, 0), u = 100 - parseInt(a.clipB, 0),
                g = Math.round(p / 2);
        ...
        var l = window.getComputedStyle(e[0], null),
            ...
            u = p ? void 0 !== c[0].id && void 0 !== o[s]._L[c[0].id] ? o[s]._L[c[0].id] : c.data() : void 0, g = 0;
        ...
        var t, s, n, l, d, c, p, u, g, m, h = e.a, f = e.b, v = e.c, y = e.d, _ = e.e, b = {}, w = {},
            x = o[f]._L[h[0].id], k = h[0].className;
        ...
        if (-1 === k.indexOf("rs_splitted_")) {
            ...
            if ("IFRAME" == h[0].nodeName && "html" === o.gA(h[0], "layertype") && (g = "slide" == e.basealign ? o[f].width : o.iWA(f, _), m = "slide" == e.basealign ? o[f].height : o.iHE(f), s.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.width : g * parseInt(e.width, 0) / 100 : R(e.width, L, "auto", g, "auto"), s.height = !jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.height : m * parseInt(e.height, 0) / 100 : R(e.height, L, "auto", g, "auto")), b = jQuery.extend(!0, b, s), "rekursive" != v) {
                ...
                if (1 == x.heightSetByVideo && (P.height = x.vidOBJ.height), x._incolumn) {
                    ...
                    O.width = "100%", void 0 !== e.display && "inline-block" !== e.display || (w = {width: "100%"}), P.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? "100%" : A, "image" === x.type && tpGS.gsap.set(x.img, {width: P.width})
    ...
    var r = function (e, i) {
        ...
        var s = i.parent().find(".tp-" + o + "s"), n = s.find(".tp-" + o + "s-inner-wrapper"),
            ...
            g = "vertical" === a.direction ? {width: d + "px"} : {height: c + "px"};
        t.add(tpGS.gsap.set(s, g)), t.add(tpGS.gsap.set(n, {
            width: p + "px",
            height: u + "px"
        })), t.add(tpGS.gsap.set(l, {width: p + "px", height: u + "px"}));
        var m = n.find(".tp-" + o);
        ...
        if (!0 === t[e].navigation.mouseScrollNavigation || "on" === t[e].navigation.mouseScrollNavigation || "carousel" === t[e].navigation.mouseScrollNavigation) {
            ...
            t[e].c.on("mousewheel DOMMouseScroll", function (r) {
                ...
                if ("carousel" === t[e].sliderType && !1 === t[e].carousel.snap) p = !1, t.swipeAnimate({
                    ...
                    var h = t[e].c.offset().top - jQuery("body").scrollTop(), f = h + t[e].c.height();
        ...
        jQuery(".bullet, .bullets, .tp-bullets, .tparrows, a").addClass("noSwipe"), t[e].navigation.touch = void 0 === t[e].navigation.touch ? {} : t[e].navigation.touch, t[e].navigation.touch.swipe_direction = void 0 === t[e].navigation.touch.swipe_direction ? "horizontal" : t[e].navigation.touch.swipe_direction, jQuery(".rs-nav-element").rsswipe({
            ...
            swipeStatus: function (i, o, s, n, d, c, p) {
                ...
                var g = l("RS-THUMB", i), h = l("RS-TAB", i);
                ...
                var f = "start" === o ? 0 : r ? p[0].end.x - p[0].start.x : i.pageX - a.screenX,
                    ...
                    y = g ? ".tp-thumbs" : ".tp-tabs", _ = g ? ".tp-thumb-mask" : ".tp-tab-mask",
                    b = g ? ".tp-thumbs-inner-wrapper" : ".tp-tabs-inner-wrapper", w = g ? ".tp-thumb" : ".tp-tab",
                    x = g ? t[e].navigation.thumbnails : t[e].navigation.tabs, k = t[e].cpar.find(_), S = k.find(b),
                ...
                switch (o) {
                    ...
                    case"move":
                        ...
                        I = I < z ? "horizontal" === L ? I + S.width() * (I - z) / S.width() * (I - z) / S.width() : I + S.height() * (I - z) / S.height() * (I - z) / S.height() : I, "vertical" === L ? tpGS.gsap.set(S, {top: I + "px"}) : tpGS.gsap.set(S, {left: I + "px"}), u(t[e].hideAllNavElementTimer);
                        break;
                    case"end":
                    case"cancel":
        ...
        "vertical" === i.direction ? (n.css({top: (l - 1) * u + "px", left: "0px"}), i.c.css({
            height: (l - 1) * u + c,
            width: d
        ...
        var u = a.data("key"), g = i.c.find(n), m = g.find(l), h = i.tmp;
        ...
        var v = i.c.find(d).length, y = f.outerWidth(), _ = f.outerHeight(),
            b = y + parseInt(void 0 === i.space ? 0 : i.space, 0),
            w = _ + parseInt(void 0 === i.space ? 0 : i.space, 0);
        "vertical" === i.direction ? (f.css({top: (v - 1) * w + "px", left: "0px"}), m.css({
            height: (v - 1) * w + _,
            width: y
        })) : (f.css({left: (v - 1) * b + "px", top: "0px"}), m.css({
            width: (v - 1) * b + y,
            height: _
        })), g.css({maxWidth: i.maxw + "px", maxHeight: i.maxh + "px"}), i.c.css({
            maxWidth: i.maxw + "px",
            maxHeight: i.maxh + "px"
        }), f.click(function () {
    ...
    jQuery.extend(!0, t, {
        preparePanZoom: function (e) {
            ...
            if (t[i].panzoomTLs = void 0 === t[i].panzoomTLs ? {} : t[i].panzoomTLs, t[i].panzoomBGs = void 0 === t[i].panzoomBGs ? {} : t[i].panzoomBGs, void 0 === t[i].panzoomBGs[r] && (t[i].panzoomBGs[r] = e), void 0 !== s.panzoom && null !== s.panzoom) {
                ...
                var g = e.data("pzimg"), m = g.parent(), h = function (e, t, i) {
        ...
        checkForParallax: function (e) {
            ...
            if (!a.done) {
                ...
                if ("3D" == a.type || "3d" == a.type) {
                    if (t.addSafariFix(e), tpGS.gsap.set(t[e].c, {overflow: a.ddd_overflow}), tpGS.gsap.set(t[e].canvas, {overflow: a.ddd_overflow}), "carousel" != t[e].sliderType && a.ddd_shadow) {
                    ...
                    function o(i) {
                        ...
                        i.find(".dddwrapper-layertobggroup").appendTo(r), "carousel" == t[e].sliderType && (a.ddd_shadow && r.addClass("dddwrappershadow"), tpGS.gsap.set(r, {borderRadius: t[e].carousel.border_radius})), tpGS.gsap.set(i, {
                            overflow: "visible",
                            transformStyle: "preserve-3d",
                            perspective: 1600
                        }), tpGS.gsap.set(r, {
                            ...
                            transformStyle: "flat",
                            transformPerspective: 1600
                        }), tpGS.gsap.set(t[e].canvas, {transformStyle: "preserve-3d", transformPerspective: 1600})
                    }
                ...
                if ("mouse" == a.type || "mousescroll" == a.type || "3D" == a.type || "3d" == a.type) {
                    ...
                    "carousel" === t[e].sliderType && (n = "rs-slide .dddwrapper, rs-slide .dddwrapper-layer, rs-static-layers .dddwrapper-layer"), a.sctors = t[e].c.find(n), a.mouseEntered = !1, t[e].c.mouseenter(function (i) {
                        var r = t[e].c.offset().top, o = t[e].c.offset().left;
            ...
            for (var f = 0; f < i.pcontainers.length; f++) {
                var v = i.pcontainers[f], y = i.pcontainer_depths[f],
                    _ = "3D" == i.type || "3d" == i.type ? y / 200 : y / 100, b = a * _, w = r * _;
                "mousescroll" == i.type ? tpGS.gsap.to(v, c, {
                    force3D: "auto",
                    x: b,
                    ease: "power3.out",
                    overwrite: "all"
                }) : tpGS.gsap.to(v, c, {force3D: "auto", x: b, y: w, ease: "power3.out", overwrite: "all"})
            }
            "3D" != i.type && "3d" != i.type || i.sctors.each(function () {
                var s = jQuery(this),
                    ...
                    u = 0 == t[e].conh ? 0 : Math.round(r / t[e].conh * n * 100) || 0, g = s.closest("rs-slide"), m = 0,
                    h = !1;
            ...
            if ("3d" != c.type && "3D" != c.type) {
                if (("scroll" == c.type || "mousescroll" == c.type) && c.pcontainers) for (var p = 0; p < c.pcontainers.length; p++) if (c.pcontainers[p].length > 0) {
                    var u = c.pcontainers[p], g = c.pcontainer_depths[p] / 100,
                        m = Math.round(t[e].scrollproc * (-g * t[e].conh) * 10) / 10 || 0,
                        h = void 0 !== o ? o : c.speedls / 1e3 || 0;
                    u.data("parallaxoffset", m), tpGS.gsap.to(u, h, {overwrite: "auto", force3D: "auto", y: m})
                }
            ...
            if (y.set && (!i || !1 === y.disable_onmobile)) {
                ...
                if (_ = _ < 0 ? 0 : _, !1 !== y._L) {
                    var b = 1 - _ * y.multiplicator_layers, w = {force3D: "true"};
                ...
                if (!1 !== y.bgs) {
                    b = 1 - _ * y.multiplicator, w = {backfaceVisibility: "hidden", force3D: "true"};
                    for (var L in "top" == y.direction && t[e].scrollproc >= 0 && (b = 1), "bottom" == y.direction && t[e].scrollproc <= 0 && (b = 1), b = b > 1 ? 1 : b < 0 ? 0 : b, y.bgs) if (y.bgs.hasOwnProperty(L)) {
    ...
    var i = function (e, t) {
        ...
        var a = e.id,
            ...
            l = !0 === e.recall ? jQuery.extend(!0, {}, t[a].lastSliderTransition) : function (e, i, a) {
                var r = "power1.in", o = "power1.out", s = "power1.inOut", n = "power2.in", l = "power2.out",
                    ...
                    u = [17, 18, 19, 20, 21, 22, 23, 24, 25, 27], g = 0, m = 1, h = 0,
                ...
                }), {nTR: g = Math.max(0, Math.min(30, g)), TR: f[h], trC: m}
        ...
        var g = !0 === e.recall ? l.ntrid : e.ntrid || 0, m = i(e.animation.masterspeed, g);
        ...
        var b = i(e.animation.easein, g), w = i(e.animation.easeout, g);
        ...
        if (0 == d) {
            ...
            var P = tpGS.gsap.timeline(), C = m / 1e3 - m / 1e3 / t[a].slots;
            ...
            var G = t[a].pr_next_bg[0].getElementsByClassName("slotslide"), M = m - m / 1.8;
            for (R = 0; R < G.length; R++) t[a].mtl.add(tpGS.gsap.fromTo(G[R], (m - R * (M / t[a].slots)) / 1e3, {
                zIndex: 10,
                opacity: 0
            }, {opacity: 1, ease: "none", delay: R * (M / t[a].slots) / 1e3}), 0)
        } else if (11 == d) {
            l.trC = Math.min(12, l.trC);
            var B = 2 == l.trC ? "#000000" : 3 == l.trC ? "#ffffff" : "transparent";
            switch (m = 0 === m ? 10 : m, l.trC) {
                case 0:
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 1e3, {autoAlpha: 0}, {
                        autoAlpha: 1,
                        force3D: "auto",
                        ease: b
                    }), 0);
                ...
                case 1:
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 1e3, {autoAlpha: 0}, {
                        ...
                        force3D: "auto",
                        ease: b
                    }), 0), t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, m / 1e3, {autoAlpha: 1}, {
                        autoAlpha: 0,
                        force3D: "auto",
                        ease: b
                    }), 0);
                ...
                case 4:
                    t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_bg.parent(), {
                        ...
                        force3D: "auto",
                        ease: b
                    }), 0), p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 2e3, {autoAlpha: 0}, {
                        autoAlpha: 1,
                        force3D: "auto",
                        ease: b
                    }), m / 2e3);
                ...
                case 12:
                    ...
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 1e3, {
                        ...
                        filter: j,
                        "-webkit-filter": j
                    }, {autoAlpha: 0, force3D: "auto", ease: b, filter: D, "-webkit-filter": D}), 0)
            }
            t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_bg.find("rs-sbg"), {autoAlpha: 1}), 0), u && t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_bg.find("rs-sbg"), {autoAlpha: 1}), 0)
        } else if (12 == d || 13 == d || 14 == d || 15 == d) {
            var N = 3 == l.trC ? m / 1300 : m / 1e3, H = m / 1e3, W = 5 == l.trC || 6 == l.trC ? 0 : t[a].width,
                F = 5 == l.trC || 6 == l.trC ? 0 : t[a].currentSlideHeight, Q = 12 == d ? W : 15 == d ? 0 - W : 0,
            ...
            if (7 != l.trC && 4 != l.trC || (W = 0, F = 0), 8 == l.trC ? (t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 20}), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 15}), 0), t[a].mtl.add(tpGS.gsap.to(t[a].pr_next_bg, .01, {
                overflow: "hidden",
                x: 0,
                y: 0,
                scale: 1,
                ...
                immediateRender: !0,
                force3D: "auto"
            }), 0)) : (void 0 !== t[a].pr_active_slide && t[a].pr_active_slide.length > 0 && t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 15}), 0), void 0 !== t[a].pr_next_slide && t[a].pr_next_slide.length > 0 && t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 20}), 0), p && t[a].mtl.add(tpGS.gsap.from(t[a].pr_next_bg, N, {
                x: Q,
                y: E,
                overflow: "hidden",
                scale: X,
            ...
            t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 20}), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 15}), 0), t[a].pr_active_bg.find(".slotslide").each(function (e) {
                t[a].mtl.add(tpGS.gsap.fromTo(this, m / 1e3, {
                    ...
                    delay: 0,
                    ease: b
                }), 0), t[a].mtl.add(tpGS.gsap.fromTo(this, m / 2e3, {opacity: 1}, {opacity: 0, delay: m / 2e3}), 0)
            }), p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 1e3 - m / 7e3, {
                x: 100 * Math.random() - 50,
                opacity: 1,
                scale: .9,
                rotationZ: 10 * Math.random() - 5
            }, {x: 0, opacity: 1, scale: 1, rotationZ: 0, ease: b, force3D: "auto", delay: m / 7e3}), 0)
            ...
            tpGS.gsap.set(t[a].c, {
                ...
                transformPerspective: 1200,
                transformOrigin: J
            }), 0), t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, m / 2e3, {z: 19 == d || 23 === d ? -200 : 0}, {
                z: 19 === d || 23 === d ? 0 : -200,
                ease: "power3.inOut",
                delay: 19 === d || 23 === d ? m / 2e3 : 0
            }), 0)), 22 !== d && 24 !== d || (u && q.push(t[a].pr_active_bg), t[a].mtl.add(tpGS.gsap.fromTo(q, m / 2e3, {z: -200}, {
                z: 0,
                ease: "power2.in",
                delay: m / 2e3
            }), 0)), u && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, m / 2e3, {z: 0}, {
                z: -200,
                ease: "power3.inOut",
                delay: 0,
                force3D: "auto"
            }), 0), !u || 19 !== d && 23 !== d || t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, m / 2e3, {autoAlpha: 1}, {
                autoAlpha: 0,
                ease: "none",
                delay: m / 2e3,
                force3D: "auto"
        ...
        } else if (26 == d) m = 0, p && (t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, .001, {autoAlpha: 0}, {
            autoAlpha: 1,
            force3D: "auto",
            ease: b
        }), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_bg.find("rs-sbg"), {autoAlpha: 1}), 0)), u && (t[a].mtl.add(tpGS.gsap.to(t[a].pr_active_bg, .001, {
            autoAlpha: 0,
            force3D: "auto",
            ease: b
            ...
            var K = t[a].pr_next_bg.find(".slot"), $ = 27 == d || 29 == d ? "-100%" : "100%",
                ...
                re = {overwrite: "all"}, oe = {autoAlpha: 0, zIndex: 1, force3D: "auto", ease: b},
                ...
                de = {autoAlpha: 1, force3D: "auto", overwrite: "all", ease: b},
                ce = {overwrite: "all", zIndex: 2, autoAlpha: 1}, pe = {autoAlpha: 1, force3D: "auto", ease: b},
        ...
        if (0 !== e.length) {
            ...
            var d = void 0 !== o[0] && void 0 !== o[0].dataset && void 0 !== o[0].dataset.lazyload ? o[0].dataset.lazyload : o.attr("src"),
                c = t[i].width, p = t[i].autoHeight ? t[i].c.height() : t[i].height, u = o.data("fxof"), g = 0,
                m = e.data("bgcolor") || "transparent", h = e.data("bgfit") || "cover",
    ...
    jQuery.extend(!0, t, {
        preLoadAudio: function (e, i) {
            ...
            switch (clearTimeout(a.videoplaywait), a.type) {
                case"youtube":
                    if (0 == e.find("iframe").length) e.append(a.videomarkup), g(e, i, !0); else if (null != a.player.playVideo) {
    ...
    var r = function (e, t, i) {
        ...
        if (n.ifr = e.find("iframe"), s(a, e), n.ifr.attr("id", d), n.startvideonow = r, n.videolistenerexist) {
            ...
            case"vimeo":
                ...
                var w, x = t.is_mobile() || t.isSafari11(), k = "RS-BGVIDEO" === e[0].tagName;

...
*/
    ...
    }, la = this || self, oa = /^[\w+/_-]+[=]{0,2}$/, pa = null;
    var qa = function () {
    }, ra = function (a) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    var rb = [], sb = [], tb = [], ub = [], vb = [], wb = {}, xb, yb, zb, Ab = function (a, b) {
        ...
        if (ua(a)) {
            ...
            switch (a[0]) {
                ...
                case "escape":
                    d = Bb(a[1], b, c);
                    if (yb && ua(a[1]) && "macro" === a[1][0] && yb.Lg(a)) return yb.bh(d);
                    d = String(d);
                    for (var t = 2; t < a.length; t++) Sa[a[t]] && (d = Sa[a[t]](d));
                    return d;
                case "tag":
                    var q = a[1];
                    if (!ub[q]) throw Error("Unable to resolve tag reference " + q + ".");
                    return d = {we: a[2], index: q};
                case "zb":
                    var u = {arg0: a[2], arg1: a[3], ignore_case: a[5]};
                    u["function"] = a[1];
                    var v = Fb(u, b, c), w = !!a[4];
                    return w ||
                    2 !== v ? w !== (1 === v) : null;
                default:
    ...
    var Hb = null, Kb = function (a) {
        ...
        for (var p = [], m = 0; m < ub.length; m++) c[m] && !d[m] && (p[m] = !0);
        return p
    }, Jb = function (a) {
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    ...
    C.Fe = [C.ca, C.ab, C.Jb];
    C.Ge = [C.da, C.Kb, C.cb];
    var hc = {}, ic = function (a, b) {
        hc[a] = hc[a] || [];
        hc[a][b] = !0
    }, jc = function (a) {
        for (var b = [], c = hc[a] || [], d = 0; d < c.length; d++) c[d] && (b[Math.floor(d / 6)] ^= 1 << d % 6);
    ...
    var G = window, H = document, kc = navigator, lc = H.currentScript && H.currentScript.src, mc = function (a, b) {
        var c = G[a];
        G[a] = void 0 === c ? b : c;
        return G[a]
    }, nc = function (a, b) {
        ...
        var e;
        if (null === pa) b:{
            var f = la.document, h = f.querySelector && f.querySelector("script[nonce]");
            if (h) {
    ...
    function Fc() {
        ...
        a.ics || (a.ics = {entries: {}, set: Gc, update: Hc, addListener: Ic, notifyListeners: Jc, active: !1});
        return a.ics
    }
    ...
    function Gc(a, b, c, d, e, f) {
        ...
        h.active = !0;
        if (void 0 != b) {
            var k = h.entries, l = k[a] || {}, p = l.region, m = c && g(c) ? c.toUpperCase() : void 0;
            d = d.toUpperCase();
            e = e.toUpperCase();
            if (m === e || (m === d ? p !== e : !m && !p)) {
                ...
                r && G.setTimeout(function () {
                    k[a] === t && t.quiet && (t.quiet = !1, Kc(a), Jc(), ic("TAGGING", 2))
                }, f)
            }
        }
    }
    ...
    function Hc(a, b) {
        ...
        c.active = !0;
        if (void 0 != b) {
            var d = Lc(a), e = c.entries, f = e[a] = e[a] || {};
            f.update = "granted" === b;
            var h = Lc(a);
            f.quiet ? (f.quiet = !1, Kc(a)) : h !== d && Kc(a)
        }
    }
    ...
    var Lc = function (a) {
        ...
        function c() {
            for (var e = 0; e < b.length; e++) if (!Mc(b[e])) return !0;
            return !1
        }
    ...
    var Rc = [C.m, C.J], Sc = function (a) {
            var b = a[C.cf];
            b && E(40);
            var c = a[C.df];
            c && E(41);
            for (var d = ua(b) ? b : [b], e = 0; e < d.length; ++e) for (var f = 0; f < Rc.length; f++) {
                var h = Rc[f], k = a[Rc[f]], l = d[e];
                Fc().set(h, k, l, "GE", "GE-TB", c)
            }
        }, Tc = function (a) {
    ...
    var vd = ud, wd = null, xd = null, yd = "//www.googletagmanager.com/a?id=" + od.s + "&cv=1", zd = {}, Ad = {},
        Bd = function () {
            var a = K.sequence || 1;
            K.sequence = a + 1;
            return a
    ...
    var Cd = function () {
        ...
        Dd && (G.clearTimeout(Dd), Dd = void 0);
        void 0 === Gd || Hd[Gd] && !Id && !Jd || (Kd[Gd] || Ld.Ng() || 0 >= Md-- ? (E(1), Kd[Gd] = !0) : (Ld.lh(), rc(Nd()), Hd[Gd] = !0, Od = Pd = Jd = Id = ""))
    }, Nd = function () {
        var a = Gd;
        if (void 0 === a) return "";
        var b = jc("GTM"), c = jc("TAGGING");
        return [Qd, Hd[a] ? "" : "&es=1", Rd[a], b ? "&u=" + b : "", c ? "&ut=" + c : "", Cd(), Id, Jd, Pd, Od, "&z=0"].join("")
    }, Sd = function () {
        return [yd, "&v=3&t=t", "&pid=" +
        ya(), "&rv=" + od.Pb].join("")
    }, Td = "0.005000" > Math.random(), Qd = Sd(), Ud = function () {
        Qd = Sd()
    }, Hd = {}, Id = "", Jd = "", Od = "", Pd = "", Gd = void 0, Rd = {}, Kd = {}, Dd = void 0, Ld = function (a, b) {
        var c = 0, d = 0;
        return {
            Ng: function () {
                if (c < a) return !1;
    ...
    var Yd = {}, Zd = new za, $d = {}, ae = {}, de = {
        ...
        ae.hasOwnProperty(a) || (Zd.set(a, b), n(Ma(a, b), $d), be())
    }, be = function (a) {
        Ba(ae, function (b, c) {
            Zd.set(b, c);
            n(Ma(b, void 0), $d);
    ...
    var le = /:[0-9]+$/, me = function (a, b, c) {
        ...
        if ("protocol" === b || "port" === b) a.protocol = ne(a.protocol) || ne(G.location.protocol);
        "port" === b ? a.port = String(Number(a.hostname ? a.port : G.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === b &&
            (a.hostname = (a.hostname || G.location.hostname).replace(le, "").toLowerCase());
        return oe(a, b, c, d, e)
        ...
        switch (b) {
            ...
            case "port":
                ...
                break;
            case "path":
                a.pathname || a.hostname || ic("TAGGING",
                    1);
        ...
        var d = "gclid dclid gclaw gcldc gclgp gclha gclgf _gl".split(" "),
            e = re(a), f = a.split(/[?#]/)[0], h = e.search, k = e.hash;
        "?" === h[0] && (h = h.substring(1));
        "#" === k[0] && (k = k.substring(1));
        h = c(h);
        k = c(k);
    ...
    var De = function (a, b, c) {
        ...
        if ("auto" === l) {
            for (var p = Be(), m = 0; m < p.length; ++m) {
                var r = "none" !== p[m] ? p[m] : void 0, t = d(f, "domain", r);
                t = e(t, c.flags);
                if (!Ce(r, c.path) && ze(t, a, b, c.Da)) return 0
            }
            return 1
        }
    ...
    function we(a, b, c) {
        for (var d = [], e = ve(a, void 0, void 0, c), f = 0; f < e.length; f++) {
            ...
            if (!b || -1 !== b.indexOf(k)) {
                var l = h.shift();
                l && (l = l.split("-"), d.push({id: h.join("."), Wb: 1 * l[0] || 1, zb: 1 * l[1] || 1}))
            }
        }
        return d
    }
    ...
    var Ae = function (a) {
        ...
        return a
    }, Fe = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, Ge = /(^|\.)doubleclick\.net$/i, Ce = function (a, b) {
        ...
        if (!Dc("gtag_cs_api") || !a || !Nc()) return !0;
        if (!Mc(a)) return !1;
        var b = Lc(a);
        return null == b ? !0 : !!b
    };
    var He = function () {
        for (var a = kc.userAgent + (H.cookie || "") + (H.referrer || ""), b = a.length, c = G.history.length; 0 < c;) a += c-- ^ b++;
        var d = 1, e, f, h;
    ...
    };var Ne = ["1"], Oe = {}, Se = function (a) {
        var b = Pe(a.prefix);
        Oe[b] || Qe(b, a.path, a.domain) || (Re(b, He(), a), Qe(b, a.path, a.domain))
    };

    function Re(a, b, c) {
        var d = Le(b, "1", c.domain, c.path), e = Me(c);
        e.Da = "ad_storage";
        Ee(a, d, e)
    }
    ...
    function Ue() {
        for (var a = Ve, b = {}, c = 0; c < a.length; ++c) b[a[c]] = c;
        return b
    }
    ...
    function Ye(a) {
        ...
        for (var b = [], c = 0; c < a.length; c += 3) {
            var d = c + 1 < a.length, e = c + 2 < a.length, f = a.charCodeAt(c), h = d ? a.charCodeAt(c + 1) : 0,
                k = e ? a.charCodeAt(c + 2) : 0, l = f >> 2, p = (f & 3) << 4 | h >> 4, m = (h & 15) << 2 | k >> 6,
                r = k & 63;
            e || (r = 64, d || (m = 64));
    ...
    var df = function () {
        var a = af, b = bf, c = cf(), d = function (h) {
        ...
        for (var d = cf().decorators, e = {}, f = 0; f < d.length; ++f) {
            var h =
                d[f], k;
            if (k = !c || h.forms) a:{
                var l = h.domains, p = a, m = !!h.sameHost;
                if (l && (m || p !== H.location.hostname)) for (var r = 0; r < l.length; r++) if (l[r] instanceof RegExp) {
                    if (l[r].test(p)) {
                        k = !0;
                        break a
                    }
        ...
        var a = mc("google_tag_data", {}), b = a.gl;
        b && b.decorators || (b = {decorators: []}, a.gl = b);
        return b
    };
    var gf = /(.*?)\*(.*?)\*(.*)/, hf = /^https?:\/\/([^\/]*?)\.?cdn\.ampproject\.org\/?(.*)/,
        jf = /^(?:www\.|m\.|amp\.)+/, kf = /([^?#]+)(\?[^#]*)?(#.*)?/;
    ...
    var nf = function (a) {
        ...
        for (c in a) if (a.hasOwnProperty(c)) {
            var d = a[c];
            void 0 !== d && d === d && null !== d && "[object Object]" !== d.toString() && (b.push(c), b.push(Ye(String(d))))
        }
        var e = b.join("*");
        ...
        $e = d;
        for (var l = 4294967295, p = 0; p < c.length; p++) l = l >>> 8 ^ $e[(l ^ c.charCodeAt(p)) & 255];
        return ((l ^ -1) >>> 0).toString(36)
    }, pf = function () {
        return function (a) {
            var b = re(G.location.href), c = b.search.replace("?", ""), d = me(c, "_gl", !0) || "";
            a.query = of(d) || {};
            ...
            try {
                if (a) {
                    ...
                    if (h && "1" === h[1]) {
                        var k = h[3], l;
                        a:{
                            for (var p = h[2], m = 0; m < b; ++m) if (p === mf(k, m)) {
                                l = !0;
                                break a
                            }
                            l = !1
                        ...
                        if (l) {
                            for (var r = {}, t = k ? k.split("*") : [], q = 0; q < t.length; q += 2) r[t[q]] = Ze(t[q + 1]);
                            return r
                        }
                    }
                }
    ...
    function sf(a, b) {
        var c = "FORM" === (a.tagName || "").toUpperCase(), d = ff(b, 1, c), e = ff(b, 2, c), f = ff(b, 3, c);
        if (Ka(d)) {
            var h = nf(d);
    ...
    var af = function (a) {
        ...
        var a = H.location.hostname, b = hf.exec(H.referrer);
        if (!b) return !1;
        var c = b[2], d = b[1], e = "";
        if (c) {
            var f = c.split("/"), h = f[1];
    ...
    var zf = /^\w+$/, Af = /^[\w-]+$/, Bf = /^~?[\w-]+$/, Cf = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp"},
        Df = function () {
            if (!Dc("gtag_cs_api") || !Nc()) return !0;
            var a = Lc("ad_storage");
            return null == a ? !0 : !!a
        }, Ef = function (a, b) {
    ...
    var Kf = function () {
        var a = re(G.location.href), b = pe(a, "query", !1, void 0, "gclid"), c = pe(a, "query", !1, void 0, "gclsrc"),
        ...
        d.gclsrc = b;
        d.dclid = c;
        if (void 0 !== a && a.match(Af)) switch (b) {
            case void 0:
                e(a, "aw");
                break;
            case "aw.ds":
    ...
    function Lf(a, b, c) {
        ...
        var f = Me(b, c, !0);
        f.Da = "ad_storage";
        var h = !1, k = Math.round(c / 1E3), l = function (p) {
            return ["GCL", k, p].join(".")
        };
            ...
            for (var d = If(b.prefix), e = 0; e < a.length; ++e) {
                ...
                if (void 0 !== Cf[f]) {
                    ...
                    if (k) {
                        ...
                        b:{
                            for (var m = l, r = ve(h, H.cookie, void 0, "ad_storage"), t = 0; t < r.length; ++t) if (Of(r[t]) > m) {
                                p = !0;
                                break b
                            }
                            p = !1
    ...
    var Qf = function (a, b, c, d, e) {
        ...
        for (var c = If(b.prefix), d = {}, e = 0; e < a.length; e++) Cf[a[e]] && (d[a[e]] = Cf[a[e]]);
        Ef(function () {
            Ba(d, function (f, h) {
    ...
    var Tf = function () {
        ...
        if (Df()) {
            ...
            if (b && b.length) for (var k = 0; k < b.length; k++) {
                ...
                "1" == l[0] && 3 == l.length && l[1] && (h[b[k].td] || (h[b[k].td] = []), h[b[k].td].push({
                    timestamp: l[1],
                    zg: l[2]
                }))
            }
    ...
    function Xf(a) {
        var b = re(G.location.href), c = pe(b, "host", !1);
        if (c && c.match(Vf)) {
    ...
    var Zf = function (a) {
        var b = Xf("gac");
        if (b) return !Uc(C.m) && a ? "0" : decodeURIComponent(b);
        var c = Uf(), d = [];
        Ba(c, function (e, f) {
        ...
        Wf(function () {
            Se(b);
            var d = Oe[Pe(b.prefix)], e = !1;
            if (d && 0 < c.length) {
                var f = K.joined_au = K.joined_au || {}, h = b.prefix || "_gcl";
            ...
            null == a && (a = e);
            if (a && d) {
                var p = Pe(b.prefix), m = Oe[p];
                m && Re(p, m, b)
            }
        })
    };
    var ag = /[A-Z]+/, bg = /\s/, cg = function (a) {
        if (g(a) && (a = Fa(a), !bg.test(a))) {
            var b = a.indexOf("-");
            if (!(0 > b)) {
    ...
    var ig = function (a, b, c) {
            if (G[a.functionName]) return b.fd && I(b.fd), G[a.functionName];
            var d = hg();
            G[a.functionName] = d;
            if (a.Rb) for (var e = 0; e < a.Rb.length; e++) G[a.Rb[e]] = G[a.Rb[e]] || hg();
            ...
            return a
        }, jg = {functionName: "_googWcmImpl", ac: "_googWcmAk", qd: "www.gstatic.com/wcm/loader.js"},
        kg = {functionName: "_gaPhoneImpl", ac: "ga_wpid", qd: "www.gstatic.com/gaphone/loader.js"},
        lg = {af: "", Gf: "5"}, mg = {
            functionName: "_googCallTrackingImpl",
            Rb: [kg.functionName, jg.functionName],
            qd: "www.gstatic.com/call-tracking/call-tracking_" + (lg.af || lg.Gf) + ".js"
        }, ng = {}, og = function (a, b, c, d) {
            E(22);
            if (c) {
                d = d || {};
                var e = ig(jg, d, a), f = {ak: a, cl: b};
            ...
            if (b && c) {
                ...
                for (var e = {
                    ...
                    ng[h.id] || (h && "AW" === h.prefix && !e.adData && 2 <= h.B.length ? (e.adData = {
                        ak: h.B[0],
                        cl: h.B[1]
                    }, ng[h.id] = !0) : h && "UA" === h.prefix && !e.gaData && (e.gaData = {gaWpid: h.containerId}, ng[h.id] = !0))
                }
            ...
            if (a) if (fg()) {
                ...
                var d = void 0, e = !1, f = b.getWithConfig(C.xf);
                if (f && ua(f)) {
                    d = [];
                ...
                if (!d || e) {
                    ...
                    if (l) {
                        ua(l) ? p = l : p = [l];
                        var m = b.getWithConfig(C.ue), r = b.getWithConfig(C.ve), t = b.getWithConfig(C.Ce),
                            q = b.getWithConfig(C.uf), u = m || r, v = 1;
                        "UA" !== a.prefix || d || (v = 5);
                        for (var w = 0; w < p.length; w++) if (w < v) if (d) pg(d, p[w], q, {
                            na: u,
                            options: t
                        }); else if ("AW" === a.prefix &&
                            a.B[1]) qg() ? pg([a], p[w], q || "US", {na: u, options: t}) : og(a.B[0], a.B[1], p[w], {
                            na: u,
                            options: t
                        }); else if ("UA" === a.prefix) if (qg()) pg([a], p[w], q || "US", {na: u}); else {
                            var y = a.containerId, x = p[w], A = {na: u};
                            E(23);
                            if (x) {
                                A = A || {};
                                var B = ig(kg, A, y), z = {};
    ...
    var vg = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/), wg = {
        cl: ["ecl"],
    ...
    var Ag = function (a) {
        ...
        d ? E(8) : d = [];
        zg() && (d = Ea(d), d.push("nonGooglePixels", "nonGoogleScripts", "sandboxedScripts"));
        0 <= va(Ea(d), "google") && E(2);
        var e = d && La(Ea(d), xg), f = {};
        return function (h) {
            var k =
                h && h[Gb.Ia];
            ...
            if (b) {
                var m;
                if (m = p) a:{
                    if (0 > va(c, k)) if (l && 0 < l.length) for (var r = 0; r < l.length; r++) {
                        if (0 > va(c, l[r])) {
                            E(11);
                            m = !1;
                            break a
    ...
    function Ig(a) {
        if (!Fg) {
            ...
            if (!a || "readystatechange" != a.type || c || !b && d) {
                Fg = !0;
                for (var e = 0; e < Hg.length; e++) I(Hg[e])
            }
            Hg.push = function () {
    ...
    function Jg() {
        if (!Fg && 140 > Gg) {
            Gg++;
            try {
                H.documentElement.doScroll("left"), Ig()
            } catch (a) {
                G.setTimeout(Jg, 50)
            }
        }
    ...
    function Rg(a) {
        ...
        if (!K._li && G.performance && G.performance.timing) {
            var b = G.performance.timing.navigationStart, c = sa(de.get("gtm.start")) ? de.get("gtm.start") : 0;
            K._li = {cst: a(c - b), cbt: a(xd - b)}
        }
    };
    var Xg = {}, Yg = function () {
    ...
    var dh = function (a, b) {
        return function () {
            var c = Yg(), d = c && c.getByName && c.getByName(a);
            if (d) {
    ...
    function ih(a, b, c, d) {
        ...
        if (h && h.length) {
            var k = h[0];
            f = ih(k.index, {D: f, C: 1 === k.we ? b.terminate : f, terminate: b.terminate}, c, d)
        }
        return f
    }
    ...
    function jh(a, b, c, d) {
        function e() {
            if (f[Gb.vf]) k(); else {
                var w = Db(f, c, []), y = Ng(c.id, String(f[Gb.Ia]), Number(f[Gb.$d]), w[Gb.wf]), x = !1;
        ...
        var f = ub[a], h = b.D, k = b.C, l = b.terminate;
        if (c.Zc(f)) return null;
        var p = Bb(f[Gb.ae], c, []);
        if (p && p.length) {
            var m = p[0], r = ih(m.index, {D: h, C: k, terminate: l}, c, d);
            if (!r) return null;
            h = r;
            k = 2 === m.we ? l : r
        }
        if (f[Gb.Qd] || f[Gb.Af]) {
            var t = f[Gb.Qd] ? vb : c.uh, q = h, u = k;
            if (!t[a]) {
                e = Ia(e);
                var v = kh(a, t, e);
                h = v.D;
    ...
    function nh(a, b) {
        ...
        for (var c = [], d = 0; d < ub.length; d++) if (a.yb[d]) {
            var e = ub[d];
            var f = b.add();
            try {
                var h = ih(d, {D: f, C: f, terminate: f}, a, d);
                h ? c.push({Ye: d, Te: Eb(e), vg: h}) : (oh(d, a), f())
            } catch (l) {
                f()
            }
        }
    ...
    function oh(a, b) {
        if (!Td) return;
        var c = function (d) {
            var e = b.Zc(ub[d]) ? "3" : "4", f = Bb(ub[d][Gb.Yd], b, []);
    ...
    var rh = !1, sh = function (a, b, c, d, e) {
        if ("gtm.js" == b) {
            if (rh) return !1;
            rh = !0
        }
        ...
        ge(a, "gtm");
        var h = {
            id: a, name: b, Zc: Ag(c), yb: [], uh: [], Ke: function () {
                E(6)
            }
        };
        h.yb = Kb(h);
        ...
        if (!k) return k;
        for (var l = 0; l < h.yb.length; l++) if (h.yb[l]) {
            var p = ub[l];
            if (p && !qd[String(p[Gb.Ia])]) return !0
        }
        return !1
    };
    ...
    var Fh;
    if (3 === od.Pb.length) Fh = "g"; else {
        var Gh = "G";
        Gh = "g";
        Fh = Gh
    }
    var Hh = {"": "n", UA: "u", AW: "a", DC: "d", G: "e", GF: "f", HA: "h", GTM: Fh, OPT: "o"}, Ih = function (a) {
        var b = od.s.split("-"), c = b[0].toUpperCase(), d = Hh[c] || "i",
    ...
    var Wh = function (a) {
        ...
        var c = setTimeout(function () {
            c = 0;
            b({tcString: "tcunavailable", internalErrorState: 1})
        }, a.ma);
        Xh(a, "addEventListener", function (d) {
            d && Yh(d) && (d.internalErrorState = Th(d), 0 != d.internalErrorState && (d.tcString = "tcunavailable"), Xh(a, "removeEventListener", null, d.listenerId), c && (clearTimeout(c), c = 0, b(d)))
        })
    };
                    ...
                    try {
                        b.addEventListener(function (c) {
                            if (!1 ===
                                ...
                                var d = {}, e;
                                for (e in bi) bi.hasOwnProperty(e) && (d[e] = !0);
                                a.Ca = d;
                                fi(a);
                                ...
                                a.tcString = c.tcString;
                                var f = {}, h;
                                for (h in bi) if (bi.hasOwnProperty(h)) if ("1" === h) {
                                    var k;
                                    if (Yh(c)) if (!1 === c.gdprApplies || "tcunavailable" === c.tcString || c.purposeOneTreatment && "DE" === c.publisherCC) k = !0; else {
    ...
    function ei() {
        var a = {};
        Sc((a.ad_storage = "denied", a.wait_for_update = 500, a))
    }

    function fi(a) {
        var b = {};
        Tc((b.ad_storage = a.Ca["1"] ? "granted" : "denied", b))
    }

    var hi = function () {
        var a = ci();
        if (a.active && void 0 !== a.cd) return Number(a.cd - a.Je)
    }, ii = function () {
        var a = ci();
        return a.active && a.Ca ? a.tcString || "" : ""
    }, ji = function (a) {
        if (!bi.hasOwnProperty(String(a))) return !0;
        var b = ci();
    ...
    function ki(a, b, c) {
        ...
        var e = Kf(), f = e.gclid || "", h = e.gclsrc, k = e.dclid || "",
            l = !a && (!f || h && "aw.ds" !== h ? !1 : !0), p = Nc();
        if (l || p) {
            var m = "" + He();
            p ? Wc(function () {
                d();
    ...
    var mi = function (a) {
        ...
        var h = cg(a), k = b == C.ba, l = h.B[0], p = h.B[1], m = void 0 !== p, r = function (N) {
                return d.getWithConfig(N)
            }, t = void 0 != r(C.M) && !1 !== r(C.M), q = !1 !== r(C.Ma), u = r(C.La) || r(C.V), v = r(C.T), w = r(C.da),
            y = r(C.ia), x = r(C.ya), A = mi(x), B = {prefix: u, domain: v, xb: w, flags: y};
        if (k) {
            var z = r(C.ra) ||
                {};
            q && (yf(z[C.ib], !!z[C.F]) && Pf(pi, B), Mf(B), Rf(["aw", "dc"], B));
            r(C.pb) && Tf();
        ...
        if (!k || !m && !D) if (!0 === r(C.Td) && (m = !1), !1 !== r(C.ca) || m) {
            var F = {
            ...
            var L =
                function () {
                    ...
                    if (!R) return null;
                    n(R, ba);
                    for (var Y = 0; Y < C.Md.length; ++Y) delete ba[C.Md[Y]];
                    return ba
                }();
            L && (F.google_custom_params = L);
            !m && r(C.R) && (F.google_gtag_event_data = {items: r(C.R), value: r(C.ja)});
            if (m && b == C.qa) {
                ...
                F.google_basket_transaction_type =
                    b;
            ...
            var Q = function (N, ba) {
                void 0 != ba && "" !== ba && (F.google_additional_conversion_params = F.google_additional_conversion_params || {}, F.google_additional_conversion_params[N] = ba)
            };
            "1" === qf(!1)._up && Q("gtm_up", "1");
            m && (Q("vdnc", r(C.me)), Q("vdltv", r(C.de)));
            e();
            ...
            (function () {
                Nc() ? Wc(function () {
                    e();
                    var N = Uc(C.m);
                    if (m) Q("gcs", Vc()), N || x || !t || (F.google_transport_url = "https://pagead2.googlesyndication.com/"), f(N); else if (N) {
                        f(N);
                        return
                    }
                    N || Qc(function () {
    ...
    var vi = function (a) {
        ...
        var c;
        if (2 === b.Y) return a("ord", ya(1E11, 1E13)), !0;
        if (3 === b.Y) return a("ord", "1"), a("num", ya(1E11, 1E13)), !0;
        if (4 === b.Y) return vi(b.sessionId) && a("ord", b.sessionId), !0;
        if (5 === b.Y) c = "1"; else if (6 === b.Y) c = b.od; else return !1;
        vi(c) && a("qty", c);
        vi(b.Tb) && a("cost", b.Tb);
        ...
        function d(x, A, B) {
            m.hasOwnProperty(x) || (A = String(A), p.push(";" + x + "=" + (B ? A : xi(A))))
        }

        var e = a.Sc, f = a.rd, h = a.protocol;
        h += f ? "//" + e + ".fls.doubleclick.net/activityi" : "//ad.doubleclick.net/activity";
        var k = ";", l = !Uc(C.m) && a.Ab;
        l && (h = "https://ade.googlesyndication.com/ddm/activity", k = "/", f = !1);
        var p = [k, "src=" + xi(e), ";type=" + xi(a.Vc), ";cat=" + xi(a.sb)], m = a.pg || {};
        Ba(m, function (x, A) {
            p.push(";" + xi(x) + "=" + xi(A + ""))
        });
        if (wi(d, a)) {
            ...
            vi(a.uc) && d("tran", a.uc);
            d("gtm", Ih());
            Nc() && (d("gcs", Vc()), c && d("gcu", "1"));
            "1" === qf(!1)._up && d("gtm_up", "1");
            !1 === a.Uf && d("npa", "1");
            if (a.Rc) {
                var r = void 0 === a.Ab ? !0 : !!a.Ab, t = Yf("dc", a.Pa, r);
                t && t.length && d("gcldc", t.join("."));
                var q = Yf("aw", a.Pa, r);
                q && q.length && d("gclaw", q.join("."));
                var u = Zf(r);
                u && d("gac", u);
                Se({prefix: a.Pa, xb: a.mg, domain: a.lg, flags: a.Rh});
                var v = Oe[Pe(a.Pa)];
                v && d("auiddc", v)
            }
    ...
    }, xi = encodeURIComponent, zi = function (a, b) {
        Nc() ? Wc(function () {
            yi(a, b);
            Uc(C.m) || Qc(function () {
                yi(a, b, !0)
    ...
    var Ai = function (a, b, c, d) {
        ...
        var b = /^u([1-9]\d?|100)$/, c = a.getWithConfig(C.fe) || {}, d = Eh(a), e = {}, f = {};
        if (Ra(c)) for (var h in c) if (c.hasOwnProperty(h) && b.test(h)) {
            var k = c[h];
            g(k) && (e[h] = k)
        }
        ...
        var c = encodeURIComponent, d = [], e = a(C.R) || [];
        if (ua(e)) for (var f = 0; f < e.length; f++) {
            var h = e[f], k = f + 1;
            b("i", k, h.id);
            b("p", k, h.price);
            b("q", k, h.quantity);
        ...
        if (b) {
            ...
            if (c) return {containerId: "DC-" + b[1], aa: b[3] ? a : "", Of: b[1], Nf: b[3] || "", sb: b[4] || "", Y: c}
        }
    }, Fi = function (a, b, c, d) {
        var e = Di(a);
        if (e) {
            var f = function (N) {
                    return d.getWithConfig(N)
                }, h = !1 !== f(C.Ma), k = f(C.La) || f(C.V), l = f(C.T), p = f(C.da), m = f(C.ia), r = f(C.bf),
                t = 3 === gg();
            if (b === C.ba) {
                var q = {prefix: k, domain: l, xb: p, flags: m}, u = f(C.ra) || {}, v = f(C.Jb),
                    w = void 0 === v ? !0 : !!v;
                h && (yf(u[C.ib], !!u[C.F]) && Pf(Ei, q), Mf(q), Rf(Ei, q), $f(w, q));
                u[C.F] && Qf(Ei, u[C.F], u[C.kb], !!u[C.jb],
                    k);
                f(C.pb) && Tf();
                if (r && r.exclusion_parameters && r.engines) if (fg()) {
                } else Ai(r, t, h, q);
                ...
                var x = {}, A = f(C.$e);
                if (Ra(A)) for (var B in A) if (A.hasOwnProperty(B)) {
                    var z = A[B];
                    void 0 !== z && null !== z && (x[B] = z)
                }
                var D = "";
                if (5 === e.Y || 6 === e.Y) D = Ci(f);
                var F = Bi(d), L = !0 === f(C.Ch);
                if (fg() && L) {
                    L = !1
                }
                var P =
                    void 0 != f(C.M) && !1 !== f(C.M), Q = {
                    sb: e.sb,
                    Rc: h,
                    lg: l,
                    mg: p,
    ...
    var Hi = function (a) {
        function b() {
            var d = c, e = Gi(JSON.stringify(a[d])),
            ...
            if (a.conversionLinkerEnabled) {
                ...
                if (h && h.length) for (var k = 0; k < h.length; k++) f += "&gclgf=" + Gi(h[k])
            }
    ...
    var Ii = /.*\.google\.com(:\d+)?\/booking\/flights.*/, Ki = function (a, b, c, d) {
        ...
        }, f = cg(a).B[0], h = !1 !== e(C.Ma), k = e(C.La) || e(C.V), l = e(C.T), p = e(C.da), m = e(C.ia);
        if (b === C.ba) {
            if (h) {
                var r = {prefix: k, domain: l, flags: m, xb: p};
                Mf(r);
                Rf(["aw", "dc"], r)
            }
            I(d.D)
        } else {
            var t = {conversion_id: f, onFailure: d.C, onSuccess: d.D, conversionLinkerEnabled: h, cookiePrefix: k},
                q = Ii.test(G.location.href);
            if (b === C.Ka) {
                var u = {
                    partner_id: f, is_direct_booking: q,
                    total_price: e(C.ja), currency: e(C.ka)
                };
                t.price = u;
                Hi(t);
                return
    ...
    var Pi = function (a, b, c, d) {
            ...
            var f = cg(a), h = function (x) {
                return d.getWithConfig(x)
            }, k = !1 !== h(C.Ma), l = h(C.La) || h(C.V), p = h(C.T), m = h(C.da), r = h(C.ia);
            if (b === C.ba) {
                var t = h(C.ra) || {};
                if (k) {
                    var q = {prefix: l, domain: p, flags: r, xb: m};
                ...
                if (/^\d+$/.test(u)) {
                    var v =
                        "https://www.googletraveladservices.com/travel/clk/pagead/conversion/" + encodeURIComponent(u) + "/";
                    if (b === C.qa) {
            ...
            {Aa: "id", Sd: "price", sa: "start_date", $a: "end_date", zf: "occupancy", Wd: "room_id", Vd: "rate_rule_id"},
        Li = ["ha"];
    var Vi = function (a, b, c, d) {
        var e = cg(a), f = !1 !== d.getWithConfig(C.Ma), h = d.getWithConfig(C.La) || d.getWithConfig(C.V),
        ...
        if (b === C.ba) {
            ...
            var p = d.getWithConfig(C.ja), m = d.getWithConfig(C.ka), r = d.getWithConfig(C.pe),
                t = d.getWithConfig(C.R), q = {};
            if (g(p) || "number" === typeof p) q.base_price_value_string = "" + m + p, q.tax_price_value_string = m + "0";
            Ra(r) && "number" === typeof r.adult && (q.adult_count = r.adult);
            if (ua(t) && 0 !== t.length) {
                var u =
                    t[0];
                if (Ra(u)) {
                    if (g(u[Ti.Aa]) || "number" === typeof u[Ti.Aa]) q.partner_hotel_id = u[Ti.Aa];
                    ...
                    if (1 !== t.length) {
                        ...
                        if (Ra(w)) {
                            ...
                            for (var y = [w[Ti.be]], x = [w[Ti.Ed]], A = [w[Ti.Kd]], B = null !== v && g(v), z = 1, D = 2; D < t.length; D++) {
                                var F = t[D];
                                Ra(F) && (y.push(F[Ti.be]), x.push(F[Ti.Ed]), A.push(F[Ti.Kd]), B && F[Ti.sa] < v && (z = D))
                            }
        ...
        if (/^\d+$/.test(a)) {
            var k = encodeURIComponent(a), l = encodeURIComponent(Wi(b)),
    ...
    var aj = function (a, b, c) {
        ...
        var d = "https://www.google-analytics.com/analytics.js", e = $g();
        if (ra(e)) {
            var f = "gtag_" + a.split("-").join("_"), h = function (w) {
                ...
                if (y) {
                    var x = y.action;
                    if ("impressions" === x) w("ec:addImpression",
                        y.Gg); else if ("promo_click" === x || "promo_view" === x) {
                        var A = y.ld;
                        w("ec:addPromo", y.ld);
                        A && 0 < A.length && "promo_click" === x && h("ec:setAction", x)
                    } else w("ec:addProduct", y.Ta), h("ec:setAction", x, y.rb)
                }
            }, l = function () {
                if (fg()) {
                } else {
            ...
            if (p.va._x_19) {
                ...
                r && (d = r);
                p.va._x_20 && !cj[f] && (cj[f] = !0, e(dh(f, p.va._x_20)))
            }
            (function () {
                ...
                e(function () {
                    if (Ra(w)) {
                        ...
                        for (A in w) if (w.hasOwnProperty(A) && /^(dimension|metric)\d+$/.test(A) && void 0 != w[A]) {
                            var B = x.get(dj(w[A]));
                            ej(y, A, B)
                        }
                    }
            ...
            (function (w) {
                if (w) {
                    var y = {};
                    if (Ra(w)) for (var x in fj) fj.hasOwnProperty(x) &&
                    gj(fj[x], x, w[x], y);
                    h("require", "linkid", y)
                }
            })(p.linkAttribution);
            ...
            b === C.xd ? (l(), h("send", "pageview", p.wa)) : b === C.ba ? (l(), rg(a, c), c.getWithConfig(C.pb) && Tf(), 0 != p.sendPageView && h("send", "pageview", p.wa), aj(a, f, c)) : "screen_view" === b ? h("send", "screenview", p.wa) : "timing_complete" === b ? (m("timingCategory", p.eventCategory, !0), m("timingVar", p.name, !0), m("timingValue", Ca(p.value)), void 0 !== p.eventLabel &&
            m("timingLabel", p.eventLabel, !0), h("send", "timing", p.wa)) : "exception" === b ? h("send", "exception", p.wa) : "optimize.callback" !== b && (0 <= va([C.wd, "select_content", C.Ka, C.Sb, C.Ub, C.fb, "set_checkout_option", C.qa, C.Yb, "view_promotion", "checkout_progress"], b) && (h("require", "ec", "ec.js"), k()), m("eventCategory", p.eventCategory, !0), m("eventAction", p.eventAction || b, !0), void 0 !== p.eventLabel && m("eventLabel", p.eventLabel, !0), void 0 !== p.value && m("eventValue", Ca(p.value)), h("send", "event", p.wa));
            if (!hj) {
                hj = !0;
                Tg();
                var u = c.C, v = function () {
                    Yg().loaded || u()
                };
                fg() ? I(v) : oc(d, v, u)
            }
        ...
        if (void 0 !== c) if (nj[b] && (c = Da(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[dj(b)] = c; else if (g(a)) d[a] = c; else for (var e in a) a.hasOwnProperty(e) && void 0 !== c[e] && (d[a[e]] = c[e])
    }, dj = function (a) {
        ...
        var b = "general";
        0 <= va([C.Nd, C.Sb, C.Od, C.fb,
            "checkout_progress", C.qa, C.Yb, C.Ub, "set_checkout_option"], a) ? b = "ecommerce" : 0 <= va("generate_lead login search select_content share sign_up view_item view_item_list view_promotion view_search_results".split(" "), a) ? b = "engagement" : "exception" === a && (b = "error");
        return b
    }, ej = function (a, b, c) {
        ...
        p && ej(k, "exp", p);
        var m = f("custom_map");
        if (Ra(m)) for (var r in m) if (m.hasOwnProperty(r) && /^(dimension|metric)\d+$/.test(r) && void 0 != m[r]) {
            var t = f(String(m[r]));
            void 0 !== t && ej(k, r, t)
        }
        for (var q = Eh(d), u = 0; u < q.length; ++u) {
            var v = q[u], w = f(v);
            if (mj.hasOwnProperty(v)) gj(mj[v], v, w, h); else if (lj.hasOwnProperty(v)) gj(lj[v], v, w, k); else if (kj.hasOwnProperty(v)) gj(kj[v], v, w,
                l); else if (/^(dimension|metric|content_group)\d+$/.test(v)) gj(1, v, w, k); else if ("developer_id" === v) {
                var y = Na(w);
                y && (k["&did"] = y)
            } else v === C.V && 0 > va(q, C.bc) && (l.cookieName = w + "_ga")
        }
        ...
        "login" === c || "sign_up" === c || "share" === c ? ej(h, "eventLabel", f(C.rf)) : "search" === c || "view_search_results" === c ? ej(h, "eventLabel", f(C.Df)) : "select_content" ===
            c && ej(h, "eventLabel", f(C.Hh));
        var x = h[C.ra] || {}, A = x[C.ib];
        ...
        k["&gtm"] = Ih(!0);
        k.hitCallback = d.D;
        Nc() && (k["&gcs"] = Vc(), Uc(C.J) || (l.storage = "none"), Uc(C.m) || (k.allowAdFeatures = !1, l.storeGac = !1));
        ...
        var p = f("custom_map");
        if (Ra(p)) for (var m = 0; h && m < h.length; ++m) {
            var r = h[m], t;
            for (t in p) p.hasOwnProperty(t) &&
            /^(dimension|metric)\d+$/.test(t) && void 0 != p[t] && ej(r, t, r[p[t]])
        }
        var q = null, u = f(C.jf);
        a === C.qa || a === C.Yb ? q = {action: a, rb: e(), Ta: d(h)} : a === C.Sb ? q = {
            action: "add",
            Ta: d(h)
        } : a === C.Ub ? q = {action: "remove", Ta: d(h)} : a === C.Ka ? q = {
            action: "detail",
            rb: e(k),
            Ta: d(h)
        } : a === C.wd ? q = {action: "impressions", Gg: d(h)} : "view_promotion" === a ? q = {
            action: "promo_view",
            ld: d(u)
            ...
            rb: {list: f(C.wc) || k},
            Ta: d(h)
        } : a === C.fb || "checkout_progress" ===
        a ? q = {
            action: "checkout",
            Ta: d(h),
            rb: {step: a === C.fb ? 1 : f(C.je), option: f(C.ie)}
        } : "set_checkout_option" === a && (q = {action: "checkout_option", rb: {step: f(C.je), option: f(C.ie)}});
        q && (q.Sh = f(C.ka));
        return q
    }, qj = {}, $i = function (a, b) {
        var c = qj[a];
    ...
    var tj = function (a, b, c) {
        ...
        if (d.aa) {
            var e = zj(a, d.aa), f = e.o;
            if (f) {
                var h = n(c), k = n(e.targetConfig[d.aa]), l = n(e.containerConfig), p = n(e.i), m = n(a.i),
                    r = ce("gtm.uniqueEventId"), t = cg(d.aa).prefix,
    ...
    sj.prototype.register = function (a, b, c) {
        if (3 !== zj(this, a).status) {
            ...
            zj(this, a).status = 3;
            c && (zj(this, a).i = c);
            var d = cg(a), e = wj[d.containerId];
            if (void 0 !== e) {
                var f = K[d.containerId].bootstrap, h = d.prefix.toUpperCase();
                K[d.containerId]._spx && (h = h.toLowerCase());
                var k = ce("gtm.uniqueEventId"), l = h, p = Ga() - f;
                if (Td && !Kd[k]) {
                    k !== Gd && (Ed(), Gd = k);
    ...
    sj.prototype.flush = function (a) {
        for (var b = this; this.h.length;) {
            ...
            if (c.i) c.i = !1, this.h.push(c); else switch (c.type) {
                case "require":
                    if (3 !== zj(this, c.aa).status && !a) return;
                ...
                case "set":
                    ...
                    break;
                case "config":
                    var d = c.h[0], e = !!d[C.hc];
                    delete d[C.hc];
                    var f = zj(this, c.aa), h = cg(c.aa), k = h.containerId === h.id;
                    e || (k ? f.containerConfig = {} : f.targetConfig[c.aa] = {});
                    f.h && e || Bj(this, C.ba, d, c);
                    f.h = !0;
                    delete d[C.eb];
                    k ? n(d, f.containerConfig) :
                        n(d, f.targetConfig[c.aa]);
                    break;
                case "event":
    ...
    var Cj = "HA GF GP G UA AW DC".split(" "), Dj = !1, Ej = {}, Fj = !1;

    function Gj(a, b) {
        var c = {event: a};
        b && (c.eventModel = n(b), b[C.Ac] && (c.eventCallback = b[C.Ac]), b[C.Kb] && (c.eventTimeout = b[C.Kb]));
        return c
    }

    var Ij = function () {
        Dj = Dj || !K.gtagRegistered, K.gtagRegistered = !0, Dj && (K.addTargetToGroup = function (a) {
            Hj(a, "default")
        });
        return Dj
    };
    var Jj = function (a) {
        ...
        b = b.toString().split(",");
        for (var c = 0; c < b.length; c++) Ej[b[c]] = Ej[b[c]] || [], Ej[b[c]].push(a)
    };
    var Kj = {
        config: function (a) {
            var b = a[2] || {};
            ...
            if (g(b) && !(3 < a.length)) {
                ...
                var e;
                var f = c && c[C.za];
                void 0 === f && (f = ce(C.za, 2), void 0 === f && (f = "default"));
                if (g(f) || ua(f)) {
                    for (var h = f.toString().replace(/\s+/g, "").split(","), k = [], l = 0; l < h.length; l++) 0 <= h[l].indexOf("-") ? k.push(h[l]) : k = k.concat(Ej[h[l]] || []);
                    e = eg(k)
                } else e = void 0;
                var p = e;
                if (!p) return;
            ...
            if (2 == a.length && a[1].getTime) return Fj = !0, Ij(), {event: "gtm.js", "gtm.start": a[1].getTime()}
        }, policy: function () {
        }, set: function (a) {
            var b;
            2 == a.length && Ra(a[1]) ? b = n(a[1]) : 3 == a.length && g(a[1]) && (b = {}, Ra(a[2]) || ua(a[2]) ? b[a[1]] = n(a[2]) : b[a[1]] = a[2]);
            if (b) {
                if (Bd(), Ij()) {
                    n(b);
                    var c = n(b);
            ...
            if (3 === a.length) {
                var b = function () {
                    Ij() && n(a[2], {subcommand: a[1]})
                };
                E(39);
                var c = a[1];
                "default" === c ? (b(), Sc(a[2])) : "update" === c && (b(), Tc(a[2]))
            }
        }
    }, Lj = {policy: !0};
    var Mj = function (a, b) {
    ...
    function Rj() {
        if (!Pj) {
            Pj = !0;
            for (var a = 0; a < Qj.length; a++) I(Qj[a])
        }
    }
    ...
    var kk = [], lk = !1, mk = function (a) {
        return G["dataLayer"].push(a)
    }, pk = function (a) {
        var b = K["dataLayer"], c = b ? b.subscribers : 1, d = 0;
        return function () {
            ++d === c && a()
        }
    };
    ...
    function qk(a) {
        var b = a._clear;
        Ba(a, function (f, h) {
            "_clear" !== f && (b && fe(f, void 0), fe(f, h))
        });
        wd || (wd = a["gtm.start"]);
        var c = a.event, d = a["gtm.uniqueEventId"];
        if (!c) return !1;
        d || (d = Bd(), a["gtm.uniqueEventId"] = d, fe("gtm.uniqueEventId", d));
        var e = rk(a);
        switch (c) {
            case "gtm.init":
                E(19), e && E(20)
                ...
                try {
                    if (ra(b)) try {
                        ...
                        var l =
                            b;
                        if (g(l[0])) {
                            var p = l[0].split("."), m = p.pop(), r = l.slice(1), t = ce(p.join("."), 2);
    ...
    var vk = function () {
        var a = mc("dataLayer", []), b = mc("google_tag_manager", {});
        ...
        a.push = function () {
            ...
            if (0 < K.SANDBOXED_JS_SEMAPHORE) {
                e = [];
                for (var f = 0; f < arguments.length; f++) e[f] = new jk(arguments[f])
    ...
    var xk = function (a) {
        this.h = function (b) {
            for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === wk.Lb ? b : a[d]);
            return c.join("")
        }
    };
    ...
    wk.Vg = function (a, b, c) {
        a instanceof wk.Jf && (a = a.h(wk.mh(b, c)), b = qa);
        return {Xc: a, D: b}
    };
    var zk = function (a, b, c) {
        ...
        var e = Ak(a), f = Ha(e, b, d);
        e[b] = c(f)
    }, Dk = function (a, b, c) {
        var d = Ak(a);
        return Ha(d, b, c)
    };
    var Ek = ["input", "select", "textarea"], Fk = ["button", "hidden", "image", "reset", "submit"], Gk = function (a) {
    ...
    var Jk = !!G.MutationObserver, Kk = void 0, Lk = function (a) {
        if (!Kk) {
            var b = function () {
                var c = H.body;
                if (c) if (Jk) (new MutationObserver(function () {
                    for (var e = 0; e < Kk.length; e++) I(Kk[e])
    ...
    var fl = G.clearTimeout, gl = G.setTimeout, T = function (a, b, c) {
        if (fg()) {
            b && I(b)
        ...
        var d;
        b ? (a.eventCallback = b, c && (a.eventTimeout = c), d = mk(a)) : d = mk(a);
        return d
    }, nl = function (a, b) {
        G[a] = b
    }, W = function (a, b, c) {
    ...
    function Ul(a, b) {
        function c(h) {
            var k = re(h), l = pe(k, "protocol"), p = pe(k, "host", !0), m = pe(k, "port"),
    ...
    function Wl(a) {
        ...
        if (a.any_of && ua(c)) {
            for (var d = 0; d < c.length; d++) if (Vl({"function": a["function"], arg0: b, arg1: c[d]})) return !0;
            return !1
        }
        switch (a["function"]) {
            case "_cn":
            ...
            case "_re":
                ...
                try {
                    var m = String(c) + p, r = Tl.get(m);
                    r || (r = new RegExp(c, p), Tl.set(m, r));
                    l = r.test(b)
                } catch (t) {
                    l = !1
                }
        ...
        return !1
    };var Xl = {}, Yl = encodeURI, X = encodeURIComponent, Zl = rc;
    var $l = function (a, b) {
        if (!a) return !1;
        var c = pe(re(a), "host");
        if (!c) return !1;
    ...
    var Ln = window, Mn = document, Nn = function (a) {
        var b = Ln._gaUserPrefs;
        if (b && b.ioo && b.ioo() || a && !0 === Ln["ga-disable-" + a]) return !0;
        try {
            var c = Ln.external;
            if (c && c._gaUserPrefs && "oo" == c._gaUserPrefs) return !0
        } catch (f) {
        }
        for (var d = te("AMP_TOKEN", String(Mn.cookie), !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
    ...
    var Zn = {};
    Zn.macro = function (a) {
        if (wk.Kc.hasOwnProperty(a)) return wk.Kc[a]
    }, Zn.onHtmlSuccess = wk.se(!0), Zn.onHtmlFailure = wk.se(!1);
    Zn.dataLayer = de;
    ...
    function ao() {
        ...
        if (K[od.s]) {
            ...
            for (var c = data.resource || {}, d = c.macros || [], e = 0; e < d.length; e++) rb.push(d[e]);
            for (var f = c.tags || [], h = 0; h < f.length; h++) ub.push(f[h]);
            for (var k = c.predicates || [], l = 0; l < k.length; l++) tb.push(k[l]);
            for (var p = c.rules || [], m = 0; m < p.length; m++) {
                for (var r = p[m], t = {}, q = 0; q < r.length; q++) t[r[q][0]] = Array.prototype.slice.call(r[q], 1);
                sb.push(t)
            }
            wb = Z;
            xb = Vl;
            ...
            Fg = !1;
            Gg = 0;
            if ("interactive" == H.readyState && !H.createEventObject || "complete" == H.readyState) Ig();
            else {

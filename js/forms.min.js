!function a(o, s, u) {
    ...
    1: [function (e, t, r) {
        ...
        var n = window.mc4wp || {}, i = e("./forms/forms.js");
        ...
        function o(e, r) {
            document.addEventListener(e, function (e) {
                if (e.target) {
                    var t = e.target;
                    (t.className && -1 !== t.className.indexOf("mc4wp-form") || t.matches && t.matches(".mc4wp-form *")) && r.call(e, e)
                }
            }, !0)
        }

        if (o("submit", function (e) {
    ...
    }, {"./forms/conditional-elements.js": 2, "./forms/forms.js": 4}], 2: [function (e, t, r) {
        "use strict";
        ...
        var i = e("form-serialize"), a = e("populate.js");
    ...
    }, {"form-serialize": 5, "populate.js": 6}], 4: [function (e, t, r) {
        "use strict";
        var n = e("./form.js"), i = [], a = {};
        ...
        t.exports = {
            get: function (e) {
                ...
                for (var t = e.form || e, r = 0; r < i.length; r++) if (i[r].element === t) return i[r];
                return s(t)
            }, on: function (e, t) {
                a[e] = a[e] || [], a[e].push(t)
            }, off: function (e, t) {
        ...
        t.exports = function (e, t) {
            ...
            for (var r = t.hash ? {} : "", n = t.serializer || (t.hash ? y : w), i = e && e.elements ? e.elements : [], a = Object.create(null), o = 0; o < i.length; ++o) {
                ...
                if ((t.disabled || !s.disabled) && s.name && (g.test(s.nodeName) && !v.test(s.type))) {
                    ...
                    if ("select-multiple" !== s.type) r = n(r, u, c); else {
                        c = [];
                        for (var l = s.options, f = !1, m = 0; m < l.length; ++m) {
                            var d = l[m], p = t.empty && !d.value, h = d.value || p;
        ...
        void 0 !== t && t.exports && (t.exports = function e(t, r, n) {
            for (var i in r) if (r.hasOwnProperty(i)) {
                var a = i, o = r[i];
                if (void 0 === o && (o = ""), null === o && (o = ""), void 0 !== n && (a = n + "[" + i + "]"), o.constructor === Array) a += "[]"; else if ("object" == typeof o) {
                    e(t, o, a);
                    continue
                }
                ...
                if (s) switch (s.type || s[0].type) {
                    ...
                    case"radio":
                    case"checkbox":
                        for (var u = 0; u < s.length; u++) s[u].checked = -1 < o.indexOf(s[u].value);
                        break;
